...
$callback_url = 'http://wbhb.win.riyao.co/demo/notify.php';
//支付成功后自动跳转url
$success_url = 'http://wbhb.win.riyao.co/demo';
//支付失败或者超时后跳转url
$error_url = 'http://wbhb.win.riyao.co/demo';
...
<body>
<form action="http://wbhb.win.riyao.co/gateway/index/checkpoint.do" method="post" id="frmSubmit">
