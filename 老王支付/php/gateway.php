...
$content_type = isset($_REQUEST['content_type']) ? $_REQUEST['content_type'] : 'json';
//商户ID->到平台首页自行复制粘贴
$account_id = isset($_REQUEST['account_id']) ? $_REQUEST['account_id'] : '10247';
//S_KEY->商户KEY，到平台首页自行复制粘贴，该参数无需上传，用来做签名验证和回调验证，请勿泄露
$s_key = isset($_REQUEST['s_key']) ? $_REQUEST['s_key'] :'623FB5CFDBCB5B';
