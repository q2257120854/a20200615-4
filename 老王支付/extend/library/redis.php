...
class redis
{
     ...
     * @return array|bool
     */
    public function zRange($key, $start, $end, $boole = false)
    {
        return $this->redis->zRange($key, $start, $end, $boole);
    }
     ...
     * @return array|bool
     */
    public function zRevRange($key, $start, $end, $boole = false)
    {
        return $this->redis->zRevRange($key, $start, $end, $boole);
    }
