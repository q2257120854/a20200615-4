                  ...
                  <div class="col-sm-10">
                   <select class="selectpicker" name="serviceConfig">
                      <optgroup label="请选择轮训规则">
                        <option value="1" <?php if (userCog::read('serviceConfig', 0)['robin'] == 1) echo 'selected';?>>随机通道 [ <?php echo SYSTEM_VERSION; ?> ] - 推荐</option>
                        <option value="2" <?php if (userCog::read('serviceConfig', 0)['robin'] == 2) echo 'selected';?>>实时收款 [ <?php echo SYSTEM_VERSION; ?> ] - 按照少到多排序</option>
                        <option value="3" <?php if (userCog::read('serviceConfig', 0)['robin'] == 3) echo 'selected';?>>顺序模式 [ <?php echo SYSTEM_VERSION; ?> ] - 自动顺序选择 - 不推荐</option>
                      </optgroup>
