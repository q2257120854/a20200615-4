...
<div class="content">
  ...
  <div class="page-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo url::s('admin/clientMenu/index');?>">菜单管理</a></li>
            ...
            <div class="panel-body">
              <form class="form-horizontal" id="from">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <textarea class="form-control form-control-line" rows="3"  name="menu_name"  placeholder="菜单名称，支持html" ><?php echo trim($result['name']);?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   	...
                   	<a href="<?php echo url::s('admin/clientMenu/index');?>" class="btn"><i class="fa fa-close"></i>取消</a>
                  </div>
                </div>
    ...
    <script type="text/javascript">
			function edit(){
				$.ajax({
			          type: "POST",
			          dataType: "json",
			          url: "<?php echo url::s('admin/clientMenu/edit',"id={$result['id']}");?>",
			          data: $('#from').serialize(),
			          success: function (data) {
			              if(data.code == '200'){
			            	  swal("操作提示", data.msg, "success")
			              	setTimeout(function(){location.href = '<?php echo url::s('admin/clientMenu/index');?>';},1500);
			              }else{
