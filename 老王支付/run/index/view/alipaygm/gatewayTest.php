...
<form action="<?php echo url::s('gateway/index/checkpoint');?>" method="post" id="frmSubmit">
	...
	<input type="hidden" name="thoroughfare" value="alipaygm_auto"/>
	...
	<input type="hidden" name="success_url" value="<?php echo url::s('index/alipaygm/automatic');?>" />
	<input type="hidden" name="error_url" value="<?php echo url::s('index/alipaygm/automatic');?>" />
