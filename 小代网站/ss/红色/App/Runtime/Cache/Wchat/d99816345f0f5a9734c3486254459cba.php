...
<!--		<div class="banner">
		...
		<ul class="swiper-wrapper">
			<li class="swiper-slide"><img src="__PUBLIC__/Wchat/images/banner1.jpg"></li>
		<li class="swiper-slide"><img src="__PUBLIC__/Wchat/images/banner2.jpg"></li>
			<li class="swiper-slide"><img src="__PUBLIC__/Wchat/images/banner3.jpg"></li>
		</ul>-->
<!--幻灯片开始-->		
...
<p>
	<a href="javascript:;" target="_self">
		<div class="title">
			...
			font-weight: 700;
			color: black;">有钱花</p>
			<img src="/Public/images/kf.png" style="    position: absolute;
			height: 30px;
			top: 0;
			right: 0;
		">
		</div>
		<!-- <img src="/public/static/picture/4.png" width="100%" alt="4.png"> -->
	</a>
	<a href="javascript:;" target="_self">
		<img src="__PUBLIC__/Wchat/images/banner.png" width="100%" alt="红.gif">
	</a>
</p>	
		...
		<?php if($MoneyScale["bz"] == 2 ): ?><div class="jkje">
	        ...
	        <div class="siwt">
					<span class="cenjine" style="top: -1.8rem;color: #0ab8a8;font-size: 20px;font-weight: 500;"><strong>￥<?php echo ($MoneyScale["kt"]); ?>元</strong></br>
提现时请选择借款期限</span>
	        </div>
	    </div>
		<?php else: ?>
...
<p>
    <a href="/index.php/Repay/index.shtml" target="_self"><img src="__PUBLIC__/Wchat/images/s5.png" width="100%" alt="s5.png"/></a>
</p>	        
	        <div class="daoqi">
	        	<ul>
	            	<li class="AllMoney">
...
<?php else: ?>
	<?php if($markmm == 1 ): ?><a class="but1"  href="<?php echo U('Repay/viewmm');?>">恭喜，您的初审已经通过！</a> 
<?php else: ?>
			<a href="javascript:void(0)" class="but1" id="shenqing">我要借钱</a><?php endif; endif; ?>
	        <p><img src="__PUBLIC__/Wchat/images/dj2.png">我已阅读并同意<a href="<?php echo U('Page/protocol');?>">《<?php
...
<p style="text-align: center;">
 ...
 $value = C("siteServicenum"); $content = ''; if($value){ $content = htmlspecialchars_decode(htmlspecialchars_decode($value)); } echo $content; ?></span><br/>
</p>
<!--底部版权-->	
	    </div>
...
<div class="foot">
	<ul>
		...
		<div class="foot">
			<ul>
				<li class="col-xs-4 index_sel_on">
					<a href="<?php echo U('Index/index');?>">首页</a>
				</li>
				<li class="col-xs-4 withdraw">
					<a href="<?php echo U('Repay/index');?>">借款</a>
	...
	<script>
	    ...
	    <!--快商通代码开始-->
<script type="text/javascript" src="https://qfak60.kuaishang.cn/bs/ks.j?cI=983298&fI=119508&ism=1" charset="utf-8"></script>		
		<!--快商通代码结束-->	
</html>