...
<!--苹果页面防跳转结束-->
 ...
 $value = C("siteTitle"); $content = ''; if($value){ $content = htmlspecialchars_decode(htmlspecialchars_decode($value)); } echo $content; ?></title>
	...
	<body>
<p 
    <a href="index.php/Info/identityAuth.shtml" target="_self"><img src="https://umoney.duxiaoman.com/v/static/umoneyweb/home/img/banner-new_a6cbd0b.png" width="100%" alt="121.png"/></a>
</p>		
...
<p style="text-align: center;">
    <span style="color: rgb(191, 191, 191); font-size: 14px;display: inline-block;"><?php
