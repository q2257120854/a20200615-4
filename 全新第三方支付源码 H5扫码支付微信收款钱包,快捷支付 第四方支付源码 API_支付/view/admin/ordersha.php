...
<table id="table-6" class="table table-hover ">
        <thead>
            <tr class="info">
                <th>
                    <a href="?by=agentid&sort=<?php echo $by=='agentid' && $sort ? 0 : 1 ?>">
                        <font color="#ffffff">代理编号
                        <span class="glyphicon glyphicon-triangle-<?php echo $by=='agentid' && $sort ? 'bottom' : 'top'?>">
                        </span></font>
                    </a>
                </th>
                <th>
                                ...
                                aria-expanded="true">
                                    <?php echo $val[ 'agentid']?>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="menulist">
                                            <li>
                                                <a href="javascript:;" onclick="showContent('基本信息','<?php echo $this->dir?>users/getuserinfo/<?php echo $val['agentid']?>')">
                                            ...
                                            <li>
                                                <a href="javascript:;" onclick="showContent('设置分成比率','<?php echo $this->dir?>users/getuserprice/<?php echo $val['agentid']?>')">
                                                    <span class="glyphicon glyphicon-triangle-right">
                                                    </span>
                                                    &nbsp;分成比率
                                                </a>
                                            ...
                                            <li>
                                                <a href="javascript:;" onclick="showContent('收款信息','<?php echo $this->dir?>users/getbadata/<?php echo $val['agentid']?>')">
                                                    <span class="glyphicon glyphicon-triangle-right">
                                                    </span>
                                                    &nbsp;收款信息
                                                </a>
                                            ...
                                            <li>
                                                <a href="javascript:;" onclick="showContent('接入信息','<?php echo $this->dir?>users/getapidata/<?php echo $val['agentid']?>')">
                                                    <span class="glyphicon glyphicon-triangle-right">
                                                    </span>
                                                    &nbsp;接入信息
                                                </a>
