...
<div class="bheader">
    ...
    <div class="aui-content aui-margin-b-15" style="float:left; width:100%;">
                ...
                <div class="aui-media-list-item-inner">
                    ...
                    <div class="aui-list-item-inner aui-list-item-arrow">
                        <div class="aui-list-item-text">
                            <div class="aui-list-item-title aui-font-size-14">订单号	<?php echo $val[ 'sn'];?></div>
                            <div style="color:#000" class="aui-list-item-right aui-font-size-18">-<?php echo $val[ 'money'];?></div>
                        </div>
