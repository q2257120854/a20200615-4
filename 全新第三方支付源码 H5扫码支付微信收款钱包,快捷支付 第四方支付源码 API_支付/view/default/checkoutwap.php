...
?>
    ...
    <html>
        ...
        <body>
            ...
            <form action="/checkout/subpay?sign=<?php echo $token?>" method="post">
                ...
                <div class="pay_list">
                   ...
                   <!--     <?php if($this->checkacc->isAccExist($userinfo['userid'],'wxh5')):?>
                            ...
                            <?php endif;?>
							-->
							 <?php 		 if($this->checkacc->isAccExist($userinfo['userid'],'gzhpay') && is_weixin()):?>
                            <li>
                                <label>
                                    <div class="fl1">
                                        <input type="radio" name="paytype" value="gzhpay">
                                        &nbsp;
                            ...
                            <?php  elseif($this->checkacc->isAccExist($userinfo['userid'],'weixin')):?>
							 <li>
                                <label>
                                    <div class="fl1">
            ...
            <!-- Modal -->
			  <div class="modal"  id="alipayadd">
      

    <div class="ystYS" style="position: fixed; top: 80%; left: 25%; z-index: 5000;">
 <a href=""  style="border: 1px solid  #fff;padding: 15px 70px;border-radius: 5px; color: #fff;">返回按钮</a>

    </div>
    <img src="/static/common/zhifubao.jpg" style="width: 100%;position: fixed; top: 0px; left: 0px; height: 100%;" >
  </div>
            ...
            <script>
			  $(function() {
                    ...
                    fp.find('input').prop('checked', true);
                    if (pt == 'bank' || pt == 'card') {
                        if (pt == 'bank') {
                            $('.banklist').show();
                        } else {
                    ...
                    $('.pay_list ul li').click(function() {
                        ...
                        if (paytype == 'card') {
                            $('.cardlist').show();
						       ...
						       if (paytype == 'alipaywap' && is_weixin()) {
