...
<body class="adaptive">
    <div class="header">
        <div class="container clearfix">
            <h1 class="logo1">
               <a href="/" title="首页"><img src="images/login2_02.png" alt="信达支付首页" /></a>  <div class="service"><i class="phone"></i>138-1996-2789</div>
            </h1>
...
<!-- 全站公告小黄条 -->
<div class="maintain_notice"><div class="container">亲爱的商户：为配合(网联)支付清算平台渠道接入工作，平台在5月2日至6月30日间部分支付通道将不定时维护，请提前做好资金安排，感谢您的理解与支持！</div></div>
<!-- 全站公告小黄条 END-->
<style type="text/css">
/*头部小黄条*/
...
/*头部小黄条 END*/
    ...
    <div class="banner" id="bannerPa">
          ...
          <div class="bannerBox" id="banner">
            ...
            <div class="login-box">
                <div id="login-box-tit" class="login-box-tit">
                   <span class="select f-f0">登录信达支付</span>
                <span class="f-f0"><a href="/register" onclick="_paq.push(['trackEvent','h5_go_reg_btn']);" target="_top">注册商户帐号</a></span>
               </div>
      ...
      <form  method="post" action="/login/sigin">

                     <ul class="login-form">
                         <li>
                             <input type="text" name="username" size="25" placeholder="请输入电子邮箱/手机号码/商户帐号" autocomplete="false"/  required>
                         </li>
                         <li class="f-cb f-pr">
                             <input type="password" name="password"  size="25"   placeholder="请输入密码" autocomplete="off" /  required>
                         </li>
                         <li class="f-pr">
                     ...
                     <div class="login-action">
                       <p class="h5_login_action_info">
                         <a href="/register" onclick="_paq.push(['trackEvent','h5_go_reg_btn']);" target="_top">注册信达支付商户账户</a> |
        	                ...
        	                <div class="reg-action-bar">
									...
									<button type="submit" class="button">激活帐号,立刻注册</button>
            	                     <p class="tks f-cb">
            	                        	...
            	                        	我同意<a target="_blank" href="i/merchant_agreement.html" class="uline">信达支付商户协议</a>
    ...
    <!--banner-->
    <div class="h5_tel">在线客服QQ： <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=986815884&site=qq&menu=yes">986815884</a><br>©2016~2018 信达支付 版权所有.<br>工信部备案号：京ICP备18007495号</div>
	   <div class="about-box">
        <div class="container">
            <h2>关于信达支付</h2>
            <h5>About Us</h5>
            <p>信达支付信息技术有限公司成立于2016年，是北京高新企业。公司拥有由互联网行业资深工作者、优秀金融界人士、高级技术人员及专职客 服人员所组成的专业管理团队，在产品开发、技术创新、市场开拓、企业管理、反洗钱等方面都积累了丰富的实战经验。公司秉承"服务、创新、合作"的企业经营理念，在努力发展 的同时，竭诚为客户带来更便捷、更安全、更贴心的服务。</p>
        </div>
    </div>
       ...
       <a href="javascript:void(0)">百度钱包</a>
        ...
        <a href="i/contact.html" target="_blank">联系我们</a>
         ...
         <li><a class="auth06" target="_blank" title="ISO9001认证" href="#">ISO9001认证</a></li>
                            ...
                            <div>版权归 北京信达支付信息技术有限公司 所有 　工信部备案号：京ICP备18007495号</div>
            </div>
        </div> 

<!-- 右侧固定栏 -->
<div class="side-bar">
    <a href="http://wpa.qq.com/msgrd?v=3&uin=691704358&site=qq&menu=yes" target="_blank" class="qqOnline" title="在线客服">
      <span></span>
      <p>在线客服</p>
  </a>
</div>
...
$(function(){
	var noticeStartDate = new Date("2018/04/20 23:59:59"),
		noticeEndDate = new Date("2018/06/30 23:59:59"),
