...
/*头部小黄条 END*/
          ...
          <div class="bannerBox" id="banner">
            ...
            <div class="login-box">
                <div id="login-box-tit" class="login-box-tit">
                   <span class="select f-f0">商户重置密码</span>
               ...
               <ul id="login-box-con" class="login-box-con">
                   <li class="con">
          <form class="form-ajax" action="/forgot/save" method="post">
                     <ul class="login-form">
                         <li>
                             <input type="password" name="password" size="25" placeholder="新密码" maxlength="20" required>
                         </li>
                          <li class="f-cb f-pr">
                             <input type="password" name="cirmpwd"  size="25"   placeholder="确认新密码" maxlength="20" required>
                         </li>
                         <li class="f-pr">
                     ...
                     <div class="login-action">
                       <p class="h5_login_action_info">
						 ...
						 <button type="submit">立 即 重 置</button>
                         <p><a tabindex="5" href="/register" onclick="_paq.push(['trackEvent','go_forget_btn']);" class="w" target="_top">注册智通付商户账户</a>
                         </p>
                     </div>
                   </form>
                   </li>
    ...
    <!--banner-->
 <div class="h5_tel">在线客服QQ： <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=986815884&site=qq&menu=yes">986815884</a><br>©2016~2018 智通付 版权所有.<br>工信部备案号：陕ICP备18007495号</div>
