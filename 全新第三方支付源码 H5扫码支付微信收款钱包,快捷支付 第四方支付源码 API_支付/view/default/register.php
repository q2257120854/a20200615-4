          ...
          <div class="bannerBox" id="banner">
            ...
            <div class="login-box">
                <div id="login-box-tit" class="login-box-tit">
                   <span class="select f-f0">注册商户帐号</span>
               ...
               <ul id="login-box-con" class="login-box-con">
                ...
                <form class="form-ajax" action="/register/save" method="post">
                     ...
                     <ul class="login-form">
                         <li>
                             <input type="text" name="email" size="25" placeholder="请输入正确的电子邮箱,接收激活邮件" maxlength="30" required autocomplete="false"/>
                         </li>
                     ...
                     <div class="login-action">
                       <p class="h5_login_action_info">
						 ...
						 <button type="submit">激活帐号,立刻注册</button>
...
<!-- 右侧固定栏 -->
<div class="side-bar">
    <a href="http://wpa.qq.com/msgrd?v=3&uin=986815884&site=qq&menu=yes" target="_blank" class="qqOnline" title="在线客服">
      <span></span>
      <p>在线客服</p>
  </a>
</div>
