                            ...
                            <div class="panel-heading">
                                <div class="panel-title">
								  ...
								  <i class="fa fa-info-circle "></i>&nbsp;<?php echo isset($msg) ? $msg : '此页面不存在'; ?></div>
									<div style="text-align:center;margin-top:40px"><a href="/member"> <?php echo $this->
            config['sitename']?>商户中心</a>
									<span class="v-line">|</span>
									<a href="<?php echo isset($url) ? $url : $this->req->server('HTTP_REFERER') ?>">返回上页</a><P>
									</div>
									</div>
									</div></div></div></div></div>
