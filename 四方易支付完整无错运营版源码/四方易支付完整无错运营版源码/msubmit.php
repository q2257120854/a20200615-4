...
$codepay_config['id'] = $conf[$ua . '_codepay_api_id'];
$codepay_config['key'] = $conf[$ua . '_codepay_api_key'];
...
?>扫码支付 - 易支付</title>
    <link href="<?php 
echo $codepay_path;
?>/css/wechat_pay.css" rel="stylesheet" media="screen">
...
echo $qr;
?>" width="210" height="210" style="display: block;">
...
?>.png"
        ...
        <div class="time-item" id="msg">
            ...
            <br><br><font color="red">请务必付款与提示金额相同的金额 否则无效<br><hr>付款后请勿提前关闭页面请等待自动返回</font>
        </div>
...
<div class="copyRight">
    <p>支付合作：<a href="//ydtdml.cn" target="_blank">YDTD</a></p>
</div>
