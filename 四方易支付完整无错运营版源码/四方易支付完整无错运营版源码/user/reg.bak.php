...
<div class="list-group-item">
<input type="text" name="account" placeholder="结算账号" value="<?php echo $_GET['openid']?>" class="form-control no-border" disabled>
</div>
<?php }else{?>
<div class="list-group-item">
<select class="form-control" name="type">
...
<label class="i-checks">
  <input type="checkbox" ng-model="agree" checked required><i></i> 同意<a href="agreement.html?123" target="_blank">我们的条款</a>
</label>
</div>
</div>
...
<p>
<small class="text-muted"><?php echo $conf['web_name']?><br>&copy; 2018</small>
</p>
</div>
</div>
</div>
...
$(document).ready(function(){
	$("select[name='type']").change(function(){
		if($(this).val() == 1){
			...
			if(!isWeixin)window.location.href='wxreg.php';
