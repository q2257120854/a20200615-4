...
for (i = 0; i < items.length; i++) {
    ...
    echo '<div class="text-center"><div class="alert alert-defauit"><form action="plist.php" method="GET" class="form-inline"><input type="hidden" name="my" value="search">
  <div class="form-group">
    <label>搜索</label>
  ...
  <button type="submit" class="btn btn-primary">搜索</button>&nbsp;<a href="./plist.php?my=add" class="btn btn-success">添加商户</a>&nbsp;<a href="./ulist.php" class="btn btn-default">普通商户管理</a>
    ...
    if ($my == 'search') {
        ...
        $con = '<div class="text-center"><div class="panel panel-default"><div class="panel-heading">包含 ' . $_GET['value'] . ' 的共有 <b>' . $numrows . '</b> 个商户</div></div></div>';
