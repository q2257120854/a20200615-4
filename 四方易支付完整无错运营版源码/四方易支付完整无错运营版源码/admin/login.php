...
if(isset($_POST['user']) && isset($_POST['pass'])){
	...
	if($_SESSION['pass_error']>5) {
		...
		$DB->query("insert into `panel_log` (`uid`,`type`,`date`,`city`,`data`) values ('1','登录乐享云支付管理系统','".$date."','".$city."','IP:".$clientip."')");
  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">乐享云支付</a>
      </div><!-- /.navbar-header -->
        ...
        <div class="panel-body">
          <form action="./login.php" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group">
              <div class="col-xs-12"><input type="submit" value="登陆" class="btn btn-default form-control"/></div>
            </div>
          </form>
        </div>
      </div>
