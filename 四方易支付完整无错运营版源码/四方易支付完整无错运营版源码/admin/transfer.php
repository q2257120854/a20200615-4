...
<div class="table-responsive">
	<table class="table table-bordered table-striped">
		<tbody>
			...
			<?php
			echo '<tr><td colspan="6" align="center"><div class="text-center"><div class="panel panel-default"><div class="panel-heading">总共<span id="hyall">'.count($list).'<span>个记录,已经处理<span id="hydx">0</span>个记录！</div></div></div></td></tr>';
			foreach($list as $row) {
      ...
      <div class="panel panel-default">
        <div class="panel-heading"><h3 class="panel-title">批量转账到支付宝</h3></div>
          <div class="panel-body box">
			...
			<button type="submit" class="btn btn-default btn-block" id="save">保存</button>
			</div>
			</form>
		</div>
      </div>
