...
$target_url = ($_SERVER['SERVER_PORT'] == '443' ? 'https://' : 'http://').$_SERVER['HTTP_HOST'].'/wxjspay.php?trade_no='.$trade_no;
?>
<html lang="zh-cn">
<head>
  <meta charset="utf-8"/>
...
<div class="panel panel-primary">
	<div class="panel-heading" style="text-align: center;"><h3 class="panel-title">
		...
		<div class="list-group" style="text-align: center;">
			...
			<div class="list-group-item"><small>提示：你可以将以上链接发到自己微信的聊天框（在微信顶部搜索框可以搜到自己的微信），即可点击进入支付<hr>如果支付遇到问题请第一时间联系客服</small></div>
