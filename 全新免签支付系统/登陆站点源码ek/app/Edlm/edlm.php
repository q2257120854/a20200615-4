<?php
	...
	class Edlm{
		function acs($appid,$dh){
			...
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, 'https://接口地址/lps/acs/'.$appid);
		...
		function wcs($appid,$dh){
			$post_data = array('dh' => $dh,'token' => md5($dh.$appid));
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, 'https://接口地址/lps/wcs/'.$appid);
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
			curl_setopt($ch, CURLOPT_POST, 1);
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
			curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);
		...
		function qcs($appid,$dh){
			$post_data = array('dh' => $dh,'token' => md5($dh.$appid));
			$ch = curl_init();
			curl_setopt($ch, CURLOPT_URL, 'https://接口地址/lps/qcs/'.$appid);
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
			curl_setopt($ch, CURLOPT_POST, 1);
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
			curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);
