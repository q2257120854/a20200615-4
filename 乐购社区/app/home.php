...
<head>
    ...
    <meta name="keywords" content="<?=$site_key?>,亿乐社区,亿卡社区,亿乐3.0,代刷,刷赞,刷会员,玖伍社区,聚梦社区,时空云"/>
    <meta name="description" content="<?=$site_key?>,亿乐社区,亿卡社区,亿乐3.0,代刷,刷赞,刷会员,玖伍社区,聚梦社区,时空云"/>
    ...
    <link rel="stylesheet" type="text/css" href="http://assests.skywl.cc/app/css/min.css">
    <link rel="stylesheet" href="http://assets.yilep.com/ylsq/assets/swiper/css/swiper.min.css">
    <link href="http://assets.yilep.com/ylsq/css/index/icon.css?v=3.0.8" rel="stylesheet">
            ...
            <div id="header" class="header" style="padding: 0px;">
               <span class="pageTitle">
                   <h1 style="font-weight:normal; font-size: inherit; display: inline-block; width: 100%; overflow: hidden; text-overflow: ellipsis;">
                       <a href="/" style="color:inherit;"><?=$site_name?><? if ($site_sname!=''){echo " -".$site_sname;}?></a></h1></span></div>
        </div>
    </div>
        ...
        <div class="multilingualArea" id="webMultilingualArea">
            <div class="multilingual">
                <div style="float:left;" class="memberEntrance">
                                            <a class="g_mullink member_a memberIcon">
				<?php if ($member_name ==''){ ?>
				<a href="/app/login.php?act=login&id=0" class="g_mullink member_a memberIcon"><i class="iconfont"></i> <span class="g_mullinkFont">登录/注册</span></a>
				<?php }else{ ?>
                    ...
                    <div style="width: calc(50% - 10px);display: inline-block;margin: 5px" v-for="(row,i) in data"
                        ...
                        <div class="thumbnail">
                            <a @click="go(row.gid)">
                                ...
                                <div
                                    style="width: calc(100% - 30px);display:block;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;color: black;font-size: 16px">
                                    {{row.name }}
                                </div>
                            </a>
                        </div>
...
<script>
    var vueData = {
        ...
        methods: {
            ...
            go: function (gid) {
                                    <?php  if ($member_name !='')
  {echo 'this.open("/app/user.php?gid=" + gid, true);'; }else{echo 'this.open("/app/login.php?act=login&gid=" + gid+"", true);';} ?>
                            },
