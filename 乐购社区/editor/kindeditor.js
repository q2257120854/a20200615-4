...
K.options = {
	...
	zIndex : 811213,
	items : [
		'source', 'fullscreen', 'clearhtml', 'quickformat', '|', 'undo', 'redo', '|', 'selectall', 'cut', 'copy', 'paste',
		'plainpaste', 'wordpaste', '|', 'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'subscript',
		'superscript', '/',
		'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold',
		'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat',  'justifyleft', 'justifycenter', 'justifyright', '|', 'preview', 'print', 'template', 'code', '/',
		'image', 'multiimage',
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'body, td {font:14px "Microsoft YaHei", "simsun", "Helvetica Neue", Arial, Helvetica, sans-serif;}',
	...
	init : function(options) {
		...
		var settings = {
			...
			upload_success_handler : function(file, serverData) {
				...
				file.url = data.url;
				data.url = file.url = file.url.substr(17);
