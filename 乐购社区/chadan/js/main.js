...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(47), __webpack_require__(134).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(47), __webpack_require__(93)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_vue_pagination__ = __webpack_require__(359);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_polyfill__ = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Turntable_vue__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Turntable_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Turntable_vue__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('turntable', __WEBPACK_IMPORTED_MODULE_3__components_Turntable_vue___default.a);

window.axios = __webpack_require__(338);
...
window.$post = function (url, params1, params2) {
  var str = '';
  if ((typeof params1 === 'undefined' ? 'undefined' : _typeof(params1)) === 'object') {
  ...
  if ((typeof params2 === 'undefined' ? 'undefined' : _typeof(params2)) === 'object') {
    for (var _k in params2) {
      str += _k + '=' + params2[_k] + '&';
    }
  } else if (typeof params2 === 'string') {
    str += params2;
  }
  return window.axios.post(url, params1 instanceof FormData ? params1 : str);
};
// 添加请求拦截器
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$post = window.$post;
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$message = function (message, type) {
  if (type === 'success') {
...
var minins = {
  methods: {
    ...
    uploadImage: function uploadImage(id) {
      $("#form-upload-image input[name='id']").val(id);
      $("#form-upload-image input[name='image']").click();
    },
    setSearchDate: function setSearchDate(start, end) {
      if (start) this.search.date_start = start;
      if (end) this.search.date_end = end;
    },
    getUid: function getUid(e) {
      var vm = this;
      var uid = e.target.value;
      if (uid.length > 0) {
        this.$post("ajax.php", { action: 'getUserInfo', uid: uid }).then(function (data) {
          if (data.status === 0) {
            vm.uInfo = data.data;
          } else {
        ...
        vm.$message('请输入正确用户编号', 'error');
      }
    }
  }
};
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.mixin(minins);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('pagination', __WEBPACK_IMPORTED_MODULE_1_laravel_vue_pagination___default.a);
...
Component.options.__file = "resources\\assets\\js\\admin\\components\\Turntable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-475e2237", Component.options)
  } else {
    hotAPI.reload("data-v-475e2237", Component.options)
  }
...
var update = __webpack_require__(364)("44c5ecc6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-475e2237\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Turntable.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-475e2237\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Turntable.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: {
    width: { type: Number, default: document.documentElement.clientWidth },
  ...
  mounted: function mounted() {
    ...
    document.getElementById('turntablePrize0').onload = function () {
      _this.draw();
    };
    document.getElementById('turntablePrize1').onload = function () {
      _this.draw();
    };
    document.getElementById('turntablePrize2').onload = function () {
      _this.draw();
    };
    this.sysIconList = [document.getElementById('turntablePrize0'), document.getElementById('turntablePrize1'), document.getElementById('turntablePrize2')];
    document.getElementById('turntablePointer').style.width = 136 / 422 * this.width + 'px';
    document.getElementsByClassName('turntable-pointer')[0].style.bottom = (210 - 68) / 422 * this.width + 'px';
  ...
  methods: {
    ...
    stop: function stop() {
      document.getElementById('turntableCanvas').removeAttribute('style');
    },
    rotate: function rotate(index, fun) {
      this.isRun = true;
      var angles = (index + 1) * (360 / this.prize.length) - 360 / (this.prize.length * 2);
      if (angles < 270) {
        angles = 270 - angles;
      } else {
      ...
      var rotate = 'rotate' + Date.parse(new Date());
      style.type = 'text/css';
      var keyFrames = '@keyframes ' + rotate + ' { 0% {  transform: rotate(0deg);  } 100% {  transform: rotate(+' + angles + 'deg);  } }';
      ...
      document.getElementById('turntableCanvas').style.animation = rotate + ' 3s 1 ease forwards';
    },
    draw: function draw() {
      // 绘画转盘
      this.drawRouletteWheel(document.getElementById('turntableCanvas'));
    },
    drawRouletteWheel: function drawRouletteWheel(canvas) {
      var _this2 = this;

      if (canvas !== null && canvas.getContext) {
        // 根据奖品个数计算圆周角度
        var arc = Math.PI / (this.prize.length / 2);
        var ctx = canvas.getContext('2d');
        // 等比例缩小
        if (!this.isScale) {
          this.isScale = true;
          ctx.scale(this.width / 422, this.width / 422);
        }
        // 在给定矩形内清空一个矩形
        ...
        for (var i = 0; this.prize.length > i; i++) {
          ...
          // 添加对应图标
          var icon = this.prize[i].icon;
          if (icon === 0) {
            ctx.drawImage(this.sysIconList[0], -15, 30, 32, 32);
          } else if (icon === 1) {
            ctx.drawImage(this.sysIconList[1], -15, 30, 32, 32);
          } else if (icon === 2) {
            ctx.drawImage(this.sysIconList[2], -15, 30, 32, 32);
          } else {
            (function () {
              var image = new Image();
              image.src = icon;
              ...
              ctx.drawImage(image, -15, 30, 32, 32);
            })();
          }
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "turntable-box",
      style: "width:" + this.width + "px;height:" + this.width + "px"
    },
    [
      _c("canvas", {
        attrs: { id: "turntableCanvas", width: this.width, height: this.width }
      }),
      _vm._v(" "),
      _c(
        "div",
        {
          staticClass: "turntable-pointer",
        ...
        [
          _c("img", {
            attrs: {
              ...
              src:
                "/images/turntable/" +
                (_vm.isRun ? "pointer-run.png" : "pointer.png")
            },
            on: {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticStyle: { display: "none" } }, [
      _c("img", {
        attrs: { src: "/images/turntable/losing.png", id: "turntablePrize0" }
      }),
      _vm._v(" "),
      _c("img", {
        attrs: { src: "/images/turntable/money.png", id: "turntablePrize1" }
      }),
      _vm._v(" "),
      _c("img", {
        attrs: { src: "/images/turntable/award.png", id: "turntablePrize2" }
      })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-475e2237", module.exports)
  }
}
...
$(document).ready(function () {
  var pjaxLoad;
  $(document).pjax('[data-pjax] a[pjax!=no], a[data-pjax]', '#pjax-container', {});
  $(document).on('pjax:send', function () {
    $(".an-loader-container").show();
  });
  $(document).on('pjax:complete', function () {
    $(".an-loader-container").hide();
    if (window.screen.width <= 768) {
      $(".js-sidebar-toggle-with-click").addClass('collapse');
    }
  });
  var pathname = window.location.pathname;
  $(".an-main-nav a").each(function () {
    var href = $(this).attr('href');
    if (href == pathname) {
      $(this).parent().addClass('active');
      $(this).parent().parent().parent().addClass("active");
      //$(this).parent().parent().parent().find('.js-show-child-nav').click()
    }
  });
  $(".an-main-nav a").click(function () {
    $(".active").removeClass('active');
    $(this).parent().addClass('active');
  });

  $("#form-upload-image input[name='image']").change(function () {
    var id = $("#form-upload-image input[name='id']").val();
    var image = $(this).val();
    var vm = new Vue();
    if (image.length > 0) {
      vm.$post('/admin', new FormData($('#form-upload-image')[0])).then(function (data) {
        if (data.status === 0) {
          $("#" + id).val(data.url);
