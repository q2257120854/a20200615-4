...
$webscan_white_url = array('ajax.php' => 'act=addshop', 'ajax.php' => 'act=getyileGoodsParam', 'ajax.php' => 'act=getjiuwuGoodsParam', '/shopedit.php' => 'my=add_submit', 'uset.php' => 'mod=site_n');
?>