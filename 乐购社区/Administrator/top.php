...
<body class="body">
	...
	<table width="100%" height="50px" style="background-color: #228AE4;margin-top:3px;color:#fff;font-size:14px;">
		<tr>
			<td style="width:240px;white-space: nowrap;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;乐购系统主控端</td>
			<td>&nbsp;</td>
	  ...
	  <div>
			<ul id="rightTab" class="title-list">
				<li id="rightLiTab" class="active" style="margin-left: 14px;">
					<a href="javascript:void(0);" id="rightTopTab0" onclick="openUrl('right.php,0')" target="main" name="rightTopTab">首页</a>
				</li>
			</ul>
	  </div>
