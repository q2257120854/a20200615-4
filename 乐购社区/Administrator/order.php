				  ...
				  <tr>
				    ...
				    <td>
				  			<form name="form2" id="form2" >
                                                       ...
                                                       <input class="txt1"  placeholder="订单号"  style="width:150px;" type="text" id="key" name="key">
	...
	<table>
		<thead>
			<tr>
			  ...
			  <th width="4%">订单号</th>
				<th width="6%">商品类型</th>
			  <th width="8%" class="table table-bordered">用户信息</th>
			  <th width="10%" class="table table-bordered">下单内容</th>
				<th width="10%" class="table table-bordered">初始数量</th>
				<th width="10%" class="table table-bordered">下单数量</th>
				<th width="10%" class="table table-bordered">当前数量</th>
				<th width="12%" class="table table-bordered">下单金额</th>
			  <th width="8%" class="table table-bordered">下单时间</th>
			  <th width="18%" class="table table-bordered">订单状态</th>
			</tr>
		</thead>
		 ...
		 <tbody>
			 	...
			 	<?php
						...
						//所有条件
if ($_GET['startTime']!='' and $_GET['endTime']!=''  and   $_GET['key']!='' )

{  $sql = 'select * from '.flag.'order  where  date between  "'.$_GET['startTime'].'"  and  "'.$_GET['endTime'].'"  and  dingdanhao  like  "%'.$_GET['key'].'%"    order by ID desc , ID desc';}

elseif ($_GET['startTime']!='' and $_GET['endTime']!=''  and   $_GET['key']=='' )
{  $sql = 'select * from '.flag.'order  where  date between  "'.$_GET['startTime'].'"  and  "'.$_GET['endTime'].'"     order by ID desc , ID desc';}

  else
 {   $sql = 'select * from '.flag.'order    order by ID desc , ID desc';
 }
			 	...
			 	<tr class="frameset_tr">
                   ...
                   <?  if ($row['key4']!='') {echo $row['keyname4'].":".$row['key4']."<br>"; } ?>
                            ...
                            <td class="table table-bordered"><? if ($row['zt'] ==0) {echo "<font color='red'>等待中</font>"; }?>
                              ...
                              <? if ($row['zt'] ==9) {echo "<font color='black'>退款中</font>"; }?></td>
		 	</tr>
				 <? }?>
			 </tbody>
			 <tfoot>
