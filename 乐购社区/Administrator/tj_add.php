...
require_once('admin_config.php');
 if (isset($_POST['提交'])){
	...
	$sql = 'insert into '.flag.'yzf ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
	...
	<div class="zl-tab-bd">
		<div class="zl-dd">
 			<form id="annForm" name="annForm" action="" method="post">
              ...
              <dl>
                <dt>
                  <label for="label2">名称：</label>
                </dt>
 			    <dd>
                  <input class="txt1" type="text"  placeholder="名称" name="name" id=""/>
                </dd>
		      </dl>
                ...
                <dt>
 			    ...
 			    <dd>
                  <input class="txt1" type="text"  placeholder="域名" name="url" id=""/>
                </dd>
		      </dl>
              
                <dl>
                <dt>
                  <label for="label2">排序：</label>
                </dt>
 			    <dd>
                  <input class="txt1" type="text"  placeholder="排序"   value="0" name="px" id=""/>
                </dd>
		      </dl>
