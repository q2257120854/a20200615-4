...
{	null_back($_POST['key4'],'请输入参数四');}
	...
	$sql = 'update '.flag.'moban set '.arrtoupdate($_data).' where id = '.$_GET['id'].'';
	if (mysql_query($sql)) {
...
<div id="body">
	<div class="zl-tab-bd">
        ...
        <?php
					...
					$result = mysql_query('select * from '.flag.'moban where id = '.$_GET['id'].'  ');
 			...
 			<form id="annForm" name="annForm" action="" method="POST">
 			  ...
 			  <dl>
                <dt>
 			    ...
 			    <dd>
                  <input class="txt1" type="text" onBlur="w_db.value=($('#w_title').toPinyin());" onChange="w_db.value=($('#w_title').toPinyin())" onKeydown="w_db.value=($('#w_title').toPinyin())"   value="<?=$row['name']?>" style="width:300px;" name="name" id="name"/>
                </dd>
		      </dl>
                     ...
                     <dl>
						  ...
						  <dd>
                            <input class="txt1" placeholder="参数一名称"  value="<?=$row['keyname1']?>" style="width:150px"    type="text" name="keyname1" id=""/>
							<input class="txt1" placeholder="参数一"   value="<?=$row['key1']?>"  style="width:135px"  type="text" name="key1" id=""/>
        <input class="txt1" placeholder="玖伍对接参数"   value="<?=$row['dkey1']?>"  style="width:135px"  type="text" name="dkey1" id=""/>
        <input class="txt1" placeholder="亿乐对接参数"   value="<?=$row['yile1']?>"  style="width:135px"  type="text" name="yile1" id=""/>
		     ...
		     <dl>
						  ...
						  <dd>
                            <input class="txt1" placeholder="参数二名称"  value="<?=$row['keyname2']?>"   style="width:150px"    type="text" name="keyname2" id=""/>
							<input class="txt1" placeholder="参数二"  value="<?=$row['key2']?>"   style="width:135px"  type="text" name="key2" id=""/>
        <input class="txt1" placeholder="玖伍对接参数"   value="<?=$row['dkey2']?>"  style="width:135px"  type="text" name="dkey2" id=""/>

        <input class="txt1" placeholder="亿乐对接参数"   value="<?=$row['yile2']?>"  style="width:135px"  type="text" name="yile2" id=""/>
			    ...
			    <dl>
						  ...
						  <dd>
                            <input class="txt1" placeholder="参数三名称"   value="<?=$row['keyname3']?>"  style="width:150px"    type="text" name="keyname3" id=""/>
							<input class="txt1" placeholder="参数三"  value="<?=$row['key3']?>"   style="width:135px"  type="text" name="key3" id=""/>
                            
        <input class="txt1" placeholder="玖伍对接参数"   value="<?=$row['dkey3']?>"  style="width:135px"  type="text" name="dkey3" id=""/>
                <input class="txt1" placeholder="亿乐对接参数"   value="<?=$row['yile3']?>"  style="width:135px"  type="text" name="yile3" id=""/>
			    ...
			    <dl>
						  ...
						  <dd>
                            <input class="txt1" placeholder="参数四名称"  value="<?=$row['keyname4']?>"  style="width:150px"    type="text" name="keyname4" id=""/>
							<input class="txt1" placeholder="参数四"   value="<?=$row['key4']?>"  style="width:135px"  type="text" name="key4" id=""/>
                            
                            
        <input class="txt1" placeholder="玖伍对接参数"   value="<?=$row['dkey4']?>"  style="width:135px"  type="text" name="dkey4" id=""/>

        <input class="txt1" placeholder="亿乐对接参数"   value="<?=$row['yile4']?>"  style="width:135px"  type="text" name="yile4" id=""/>
