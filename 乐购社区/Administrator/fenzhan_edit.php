...
require_once('admin_config.php');
 if (isset($_POST['提交'])){
	...
	$sql = 'update '.flag.'fenzhan_banben set '.arrtoupdate($_data).' where id = '.$_GET['id'].'';
	if (mysql_query($sql)) {
...
<div id="body">
	<div class="zl-tab-bd">
        ...
        <?php
					...
					$result = mysql_query('select * from '.flag.'fenzhan_banben where id = '.$_GET['id'].'  ');
 			...
 			<form id="annForm" name="annForm" action="" method="POST">
 			  ...
 			  <dl>
						  ...
						  <dd>
 				<label><input   <? if (strpos($row['qx'],'公告管理') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="公告管理"><i>✓</i>公告管理</label> 

 
  				<label><input   <? if (strpos($row['qx'],'系统设置') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="系统设置"><i>✓</i>系统设置</label> 


  				<label><input   <? if (strpos($row['qx'],'站点装饰') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="站点装饰"><i>✓</i>站点装饰</label> 

   				<label><input   <? if (strpos($row['qx'],'客服管理') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="客服管理"><i>✓</i>客服管理</label> 

   				<label><input   <? if (strpos($row['qx'],'代理设置') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="代理设置"><i>✓</i>代理设置</label> 
                  ...
                  <dl>
   				...
   				<label><input   <? if (strpos($row['qx'],'商品管理') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="商品管理">
   				</label>
   				<label><input   <? if (strpos($row['qx'],'分站管理') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="分站管理"><i>✓</i>分站管理</label> 
   				<label><input   <? if (strpos($row['qx'],'卡密管理') !==false) {echo "checked";}?> name="qx[]" type="checkbox" value="卡密管理"><i>✓</i>卡密管理</label> 
