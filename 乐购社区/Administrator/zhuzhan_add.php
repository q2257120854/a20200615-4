...
require_once('admin_config.php');
 if (isset($_POST['提交'])){
	...
	$sql = 'insert into '.flag.'zhuzhan_banben ('.$str[0].') values ('.$str[1].')';
	if (mysql_query($sql)) {
...
<div id="body">
 			...
 			<form id="annForm" name="annForm" action="" method="post">
 			  ...
 			  <dl>
                <dt>
 			    ...
 			    <dd>
                  <input class="txt1" type="text" onBlur="w_db.value=($('#w_title').toPinyin());" onChange="w_db.value=($('#w_title').toPinyin())" onKeydown="w_db.value=($('#w_title').toPinyin())"  style="width:300px;" name="z_name" id="z_name"/>
                </dd>
		      </dl>
              ...
              <dl>
						  ...
						  <dd>
                            <input class="txt1" type="text" style="width:300px;" name="z_price" id="z_price"/>
                          </dd>
			  </dl>
                  ...
                  <dl>
						  ...
						  <dd>
                            <input class="txt1" type="text" style="width:300px;" name="czsxf" id="czsxf"/>
                          </dd>
			  </dl>
                  ...
                  <dl>
						  ...
						  <dd>
                            <input class="txt1" type="text" style="width:300px;" name="txsxf" id="txsxf"/>
                          </dd>
			  </dl>
  ...
  <tr align="right">
    ...
    <td width="40" align="left">  <dd>
                            <input class="txt1" type="text" style="width:105px;" name="w_fed" id=""/>
                          </dd></td>
    <td width="30"  align="left">   </td>
    <td width="160"  align="LEFT"><label for="label3">续费价：</label></td>
    <td width="211"  align="LEFT"><dd>   <input class="txt1" type="text" style="width:117px;" name="w_xfprice" id=""/></dd></td>
  </tr>
</table>
  ...
  <tr align="right">
    ...
    <td width="40" align="left">  <dd>
                            <input class="txt1" type="text" style="width:105px;" name="w_fed2" id=""/>
                          </dd></td>
    <td width="30"  align="left">   </td>
    <td width="160"  align="LEFT"><label for="label3">续费价：</label></td>
    <td width="211"  align="LEFT"><dd>   <input class="txt1" type="text" style="width:117px;" name="w_xfprice2" id=""/></dd></td>
  </tr>
</table>
  ...
  <tr align="right">
    ...
    <td width="40" align="left">  <dd>
                            <input class="txt1" type="text" style="width:105px;" name="w_fed3" id=""/>
                          </dd></td>
    <td width="30"  align="left">   </td>
    <td width="160"  align="LEFT"><label for="label3">续费价：</label></td>
    <td width="211"  align="LEFT"><dd>   <input class="txt1" type="text" style="width:117px;" name="w_xfprice3" id=""/></dd></td>
  </tr>
</table>
...
<dl> <dt>
    ...
    <dd>
        ...
        <label>
			...
			<input name="qx[]" type="checkbox" value="批量下单"><i>✓</i>批量下单</label>
    </dd>
                ...
                <dl style="display:none">
						  ...
						  <dd>
 				<label><input  name="z_qx11" value="1" type="checkbox"><i>✓</i>权限11</label> 
				<label><input  name="z_qx12" value="1" type="checkbox"><i>✓</i>权限12</label> 
				<label><input  name="z_qx13" value="1" type="checkbox"><i>✓</i>权限13</label> 
				<label><input  name="z_qx14" value="1" type="checkbox"><i>✓</i>权限14</label> 
				<label><input  name="z_qx15" value="1"  type="checkbox"><i>✓</i>权限15</label> 
				<label><input  name="z_qx16" value="1"   type="checkbox"><i>✓</i>权限16</label> 
				<label><input  name="z_qx17" value="1" type="checkbox"><i>✓</i>权限17</label> 
				<label><input  name="z_qx18" value="1" type="checkbox"><i>✓</i>权限18</label> 
				<label><input  name="z_qx19" value="1" type="checkbox"><i>✓</i>权限19</label> 
				<label><input  name="z_qx20" value="1" type="checkbox"><i>✓</i>权限20</label> 
