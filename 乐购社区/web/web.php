		...
		<thead>
		 ...
		 <tbody>
			 	...
			 	<?php
							 ...
							 if ($_GET['key']!='') 
							 {$sql = 'select * from '.flag.'zhuzhan where name like "%'.$_GET['key'].'%"  or  url like "%'.$_GET['key'].'%" and fxid = '.$admin_ID.'  order by ID desc , ID desc';}
 							 elseif ($_GET['startTime']!='') 
							 {$sql = 'select * from '.flag.'zhuzhan where ddate between  "'.$_GET['startTime'].'"  and  "'.$_GET['endTime'].'" and fxid = '.$admin_ID.' order by ID desc , ID desc';}
 							 else
							 {$sql = 'select * from '.flag.'zhuzhan where fxid = '.$admin_ID.' order by ID desc , ID desc';}
