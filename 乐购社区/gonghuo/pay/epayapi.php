...
/**************************请求参数**************************/
        $notify_url = "http://".$_SERVER['HTTP_HOST']."/admin/pay/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = "http://".$_SERVER['HTTP_HOST']."/admin/pay/return_url.php";
	 ...
	 null_back($_POST['money'],'请输入充值金额');  
	 
	 $czsxf=$_POST['money']*($site_czsxf/100);
	 $czje = $_POST['money']+$czsxf;
