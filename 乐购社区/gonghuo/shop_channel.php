                    ...
                    <div class="smart-widget-body table-responsive" style="overflow-y: hidden;">
                        <table class="table table-bordered">
						 ...
						 $c_name=str_replace($_GET['key'],"<font color=red> ".$_GET['key']."</font>",$row['name']);
 							...
 							?>
                              <tr>
                                <td><a href="../index.php?id=<?=$row['ID']?>" class="btn-xs btn-info"><?=$c_name?></a></td>
                                <td><a data-toggle="modal" data-target="#modal-sort" class="btn-xs btn-primary"><?=$row['corder']?></a></td>
                                <td><? if ($row['zt']==1){echo "启动中";} else {echo "关闭中";}?> </td>
                                <td><?=$row['date']?></td>
