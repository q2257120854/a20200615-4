 <?
    ...
    $data = array('Api_UserName'=>$loginname,'Api_UserMd5Pass'=>md5($loginpassword),'goods_id'=>$duijiesid,'goods_type'=>$duijiesqlx,'need_num_0'=>$_POST['num'],$duijiekey1=>$_POST[$duijiekey1],$duijiekey2=>$_POST[$duijiekey2],$duijiekey3=>$_POST[$duijiekey3],$duijiekey4=>$_POST[$duijiekey4],'pay_type'=>$duijiefs);  //定义参数  
