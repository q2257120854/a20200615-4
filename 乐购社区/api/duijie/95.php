 <?
    ...
    $data = array('Api_UserName'=>$loginname,'Api_UserMd5Pass'=>md5($loginpassword),'goods_id'=>$s_duijiesid,'goods_type'=>$s_duijiesqlx,'need_num_0'=>$_GET['num'],$canshu1=>$_GET[$key1],$canshu2=>$_GET[$key2],$canshu3=>$_GET[$key3],$canshu4=>$_GET[$key4],'pay_type'=>$duijiefs);  //定义参数  
