...
<head>
    ...
    <meta name="keywords" content="<?=$site_key?>,卡密社区,乐购,乐购云,乐购云社区,亿乐社区,乐购社区系统,乐购云系统,www.96ca.com,乐购卡密社区系统(www.96ca.com)"/>
    <meta name="description" content="<?=$site_des?>,卡密社区,乐购,乐购云,乐购云社区,亿乐社区,乐购社区系统,乐购云系统,www.96ca.com,乐购卡密社区系统(www.96ca.com)"/>
    <link href="/assets/show/css/main.css" rel="stylesheet">
    <link href="/assets/show/css//bootstrap.min.css" rel="stylesheet">
...
?>
      <li class="nav-item">
                    <a class="nav-link " href="<?=$site_dh[$i][1]?>" target="_blank"><i class="iconfont"></i> <?=$site_dh[$i][0]?></a>
                </li>
   <?php $i++;} ?>
...
{$result1 = mysql_query('select * from '.flag.'shop where   zt = 1 and zid = '.$zhu_id.'   order by sorder desc ,ID desc'); 	}
 ...
 elseif ($zhu!='true' && $_GET['cid']!='')
 {$result1 = mysql_query('select * from '.flag.'fshop where cid in ('.$_GET['cid'].')  and  zid = '.$zhu_id.'  and fid = '.$fen_id.'  order by ID desc ,ID desc'); 	}

 elseif ($zhu!='true' && $_GET['cid']=='')
 {$result1 = mysql_query('select * from '.flag.'fshop where  zid = '.$zhu_id.'  and fid = '.$fen_id.'  order by ID desc ,ID desc'); 	}
...
<script src="/assets/show/js/jquery.min.js"></script>
<script src="/assets/show/js/popper.min.js"></script>
<script src="/assets/show/js/bootstrap.min.js"></script>
<script src="/assets/admin/js/layer.js"></script>
