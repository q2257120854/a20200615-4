...
<head>
    ...
    <!-- Bootstrap -->
    <link href="/template/pc01/assets//common/bootstrap-3.3.5/css/bootstrap.min.css" rel="stylesheet">
    <link href="/template/pc01/assets//common/font-awesome_4.6.3/css/font-awesome.min.css" rel="stylesheet">
    <link href="/template/pc01/assets//index/default/order.css" rel="stylesheet">
    <link href="/template/pc01/assets//common/toastr/toastr.min.css" rel="stylesheet">
    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="/template/pc01/assets//common/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="/template/pc01/assets//common/respond.js/1.4.2/respond.min.js"></script>
    <link rel="shortcut icon" href="/template/pc01/assets//favicon.ico"/>
    <![endif]-->
				...
				elseif ($_GET['sid']=='' and  $_GET['zt']=='' and  $_GET['key']!='' ) 
					{	$result = mysql_query('select * from '.flag.'order where  dingdanhao like "%'.$_GET['key'].'%"  and zid = '.$zhu_id.'    or  key1  like "%'.$_GET['key'].'"  and zid = '.$zhu_id.' or key2  like "%'.$_GET['key'].'" and zid = '.$zhu_id.'  or  key3 like "%'.$_GET['key'].'" and zid = '.$zhu_id.'  or  key4 like "%'.$_GET['key'].'" and zid = '.$zhu_id.'    order by ID desc ,ID desc');}			
                      ...
                      <div class="col-xs-12 text-center alert alert-warning" v-if="isLoading">
                            <img src="/template/pc01/assets//common/images/ajax-loader-6.gif" title="加载中">
                        </div>
                  </div>
                </div>
            </div>
...
<script src="/template/pc01/assets//common/jquery.min.js"></script>
<script src="/template/pc01/assets//common/bootstrap-3.3.5/js/bootstrap.js"></script>
<script src="/template/pc01/assets//common/toastr/toastr.min.js"></script>
<script src="/template/pc01/assets//common/md5.min.js"></script>
<script src="/template/pc01/assets//common/layer_mobile/layer.js"></script>
<script src="/template/pc01/assets//common/vue.min.js"></script>
<script src="/template/pc01/assets//common/klsf.js?v=1"></script>
<script>
    new Vue({
        el: '#vue-page',
        data: {
