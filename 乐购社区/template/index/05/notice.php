...
<head>
    ...
    <link href="template/index/03/assets/common/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
    <link href="template/index/03/assets/common/bootstrap/3.3.6/css/bootstrap-theme.min.css" rel="stylesheet">
    <link rel="stylesheet" href="template/index/03/assets/index/default/style2.css">
...
<!--顶部-->
<header  style="margin-top:-22">
    <div class="container-fluid menu web_title"  style="background-color:<?=$site_topcolor?>">
        <div class="container">
            <h2 class="text-center"><strong><?=$site_name?>-只做稳定售后好的业务</strong></h2>
        </div>
    </div>
</header>
<!--中间-->
