...
<script>!window.jQuery && document.write("<script src=\"http://assets.19sky.cn/template/js/jquery-1.11.1.min.js\">" + "</scr" + "ipt>");</script>
<style>
    .rides-cs {
        font-size: 12px;
        background: #29a7e2;
...
<script src="http://assets.19sky.cn/template/js/jquery/1.12.0/jquery.min.js" type="text/javascript" charset="utf-8"></script>
<script src="http://assets.19sky.cn/template/js/bootstrap/3.3.6/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
<script src="http://assets.19sky.cn/template/js/toastr/toastr.min.js"></script>
<script src="http://assets.19sky.cn/template/js/md5.min.js"></script>
<script src="http://assets.19sky.cn/template/js/layer_mobile/layer.js"></script>
<script src="http://assets.19sky.cn/template/js/klsf.js"></script>
