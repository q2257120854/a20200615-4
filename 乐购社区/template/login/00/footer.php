...
<script>!window.jQuery && document.write("<script src=\"/<?=$site_skin?>assets/style/jquery-1.11.1.min.js\">" + "</scr" + "ipt>");</script>
<style>
    .rides-cs {
        font-size: 12px;
        background: #29a7e2;
...
<script src="/template/login/<?=$site_moban3?>/assets/common/bootstrap/3.3.6/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
