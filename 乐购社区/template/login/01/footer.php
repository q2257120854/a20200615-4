...
<script>!window.jQuery && document.write("<script src=\"/template/login/<?=$site_moban3?>/assets/style/js/jquery-1.11.1.min.js\">" + "</scr" + "ipt>");</script>
<style>
    .rides-cs {
        font-size: 12px;
        background: #29a7e2;
    ...
    .rides-cs .btnOpen, .rides-cs .btnCtn {
        ...
        top: 25px;
        left: 0;
        background-image: url(/doc/file/img/lanrenzhijia.png);
...
<script src="/template/login/<?=$site_moban3?>//assets/common/jquery/1.12.0/jquery.min.js" type="text/javascript" charset="utf-8"></script>
<script src="/template/login/<?=$site_moban3?>//assets/common/bootstrap/3.3.6/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
<script src="/template/login/<?=$site_moban3?>//assets/common/toastr/toastr.min.js"></script>
<script src="/template/login/<?=$site_moban3?>//assets/common/md5.min.js"></script>
<script src="/template/login/<?=$site_moban3?>//assets/common/layer_mobile/layer.js"></script>
<script src="/template/login/<?=$site_moban3?>//assets/common/klsf.js"></script>
