...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_polyfill__ = __webpack_require__(136);
...
window.axios.interceptors.request.use(function (config) {
  config['load'] = layer.hasOwnProperty('load') ? layer.load({ type: 2, shadeClose: false }) : layer.open({
    type: 2,
    shadeClose: false
  });
  return config;
