...
{	  $sql = 'select * from '.flag.'zhuzhanpricejl where   zid ='.$zhu_id.'  and   lx ="'.$_GET['lx'].'"  and  date between  "'.$_GET['date1'].'"  and  "'.$_GET['date2'].'"       order by ID desc , ID desc';}

//只搜索						 
  if ( $_GET['lx']=='' and    $_GET['date1']!='' and  $_GET['date2']!=''  )	 
{	  $sql = 'select * from '.flag.'zhuzhanpricejl where   zid ='.$zhu_id.'  and    date between  "'.$_GET['date1'].'"  and  "'.$_GET['date2'].'"       order by ID desc , ID desc';}

//只类型						 
  if ( $_GET['lx']!='' and    $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'zhuzhanpricejl where    zid ='.$zhu_id.'  and   lx ="'.$_GET['lx'].'"     order by ID desc , ID desc';}

   			 //无条件状态
  elseif ($_GET['lx']=='' and   $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'zhuzhanpricejl  where   zid ='.$zhu_id.'    order by ID desc , ID desc';}
