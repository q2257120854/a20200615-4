...
<?php 
              ...
              <input type="checkbox" name="id[]" value="<?=$row['ID']?>"  >
                         <label :for="'select_'+record.kid"></label>
                          ...
                          <td><span class="badge badge-info"><?=get_shop($row['sid'],"name")?>（<?=$row['sid']?>）
</td>
                                <td><a class="badge badge-success"> <?=$key?></td>
                                <td><span class="badge badge-warning"><? if($row['zt']==0){echo "<font color='green'>正常</font>";} ?><? if($row['zt']==1){echo "<font color='red'>已售</font>";} ?></td>
                                <td><span class="badge badge-primary"><?=$row['hyname']?>[<?=$row['hyid']?>]</td>
                                <td><span class="badge bg-gradient-yellow"><?=$row['pdate']?></td>
                                <td>
