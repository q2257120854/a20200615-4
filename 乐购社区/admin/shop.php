    ...
    <div class="row">
                ...
                <div class="panel">
                    <div class="panel-heading bg-gradient-vine">
                       商品列表 - <a href="shop_add.php" class="btn-xs btn-danger" data-pjax>添加</a>
                    </div>
						 ...
						 { $pingtaiurl='&pingtai='.$row['duijie'].''; }
 							?>
                              ...
                              <td><input type="checkbox" name="id[]" value="<?=$row['ID']?>" style="background:none; border:none;"></td>
                                <td><span class="badge badge-info"><?=$row['ID']?></td>
                                <td><a class="badge badge-success"> <?=$row['sorder']?></a></td>
                                <td><span class="badge bg-gradient-yellow"><?php
if ($row['xid']==0){echo '发卡';}else{    echo get_moban($row['xid']);}?>&nbsp;</td>
                                <td><a href="/login/<?=$row['ID']?>" target="_blank"><span class="badge badge-primary"><?=$s_name?></A></td>
                                <td><span class="badge badge-warning"><?=get_shop_channel($row['cid'])?></td>
                                <td><span class="badge badge-success"><?=$row['price']?>(<?=$row['unit']?>)</td>
                                <td><span class="badge badge-primary"><?php if ($row['zt']==1){echo "启用中</span>";} else {echo "禁用中</span>";}?></td>
                                <td><span class="badge badge-warning"><?php if ($row['duijie']!=0){echo "启用中</span>";} else {echo "禁用中</span>";}?></td>
                                <td>          
