            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading bg-gradient-vine">
                        我的一卡通  -<a href="#" data-toggle="modal" data-target="#modal-createKm"
                      ...
                      <form id="search_form" class="form-inline" method="get" role="form">
                            ...
                            <select   name="rmb" class="form-control">
                             ...
                             <select    name="zt"  class="form-control">
                               ...
                               <a class="btn btn-info"  onclick="document.getElementById('search_form').submit();return false"  > <i class="iconfont">&#xe652;</i>搜索</a>
...
elseif ($_GET['rmb']!='' and  $_GET['zt']!='' and  $_GET['key']=='' )	
 ...
 elseif ($_GET['rmb']!='' and  $_GET['zt']=='' and  $_GET['key']=='' )	
              ...
              <input type="checkbox" name="id[]" value="<?=$row['ID']?>"  >
                                                                ...
                                                                <td><span class="badge bg-gradient-yellow"><?=$key?></td>
                                <td><a class="badge badge-success"> <?=$row['point']?></td>
                           ...
                           <a class="badge badge-success"> <td><?=$row['cdate']?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated flipInX">
                ...
                <div class="modal-footer">
                    ...
                    <input name="提交" class="an-btn an-btn-success"  type="submit" value="生成">
                 </div> </form>
            </div>
        </div>
    </div>
