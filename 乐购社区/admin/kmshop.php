  ...
  <div id="vue-page">
    <div class="row">
                ...
                <div class="panel">
                    ...
                    卡密商品 - <a href="shop_add.php?xid=0" class="btn-xs btn-danger" data-pjax>添加</a>
						 ...
						 { $pingtaiurl='&pingtai='.$row['duijie'].''; }
 							?>
                              ...
                              <tr>
                                ...
                                <td><a class="badge badge-success"> <?=$row['price']?>(<?=$row['unit']?>)</td>
                                <td><span class="badge bg-gradient-yellow"><? if ($row['zt']==1){echo "启用中</span>";} else {echo "禁用中</span>";}?></td>
                                <td>
