...
{	  $sql = 'select * from '.flag.'xfjl  where zid = '.$zhu_id.'   order by ID desc , ID desc';}
                          ...
                          <tr>
                            ...
                            <td><a class="badge badge-success"> <?php if($row['fid']!=''){echo $row['fid'];}else{echo $row['zid']; }?> &nbsp;</td>
                            <td><a class="badge badge-primary"> <?=$row['xf_qje']?></td>
                            <td><a class="badge badge-warning"> <?=$row['xf_je']?></td>
                            <td><a class="badge badge-info"> <?=$row['xf_hje']?></td>
                            <td><a class="badge badge-success"> <?=$row['xf_date']?></td>
                            <td><a class="badge badge-warning"> <?=$row['xf_qk']?></td>
                            <td>                                 <a  href="javascript:if(confirm('确定要删除该记录吗?'))location='?act=del&id=<?=$row['ID']?>'"  class="btn-xs btn-warning" >删除</a></td>
</td>
                          </tr>
                          <? }?>
                        </tbody>
