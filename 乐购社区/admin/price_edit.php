...
<script type="text/javascript" src="http://assets.19sky.cn/assets/js/ui.js"></script>
<script type="text/javascript" src="http://assets.19sky.cn/assets/js/admin.js"></script>
...
<div class="alert alert-success">此加价模板列表，是在你的拿货价格基础上进行加价！</div> <!----> 
 ...
 <div class="form-group"><label class="col-sm-3 control-label no-padding-right">模板名称</label> <div class="col-sm-9"><input type="text" name="name"   value="<?=$row['p_name']?>" placeholder="输入模板名称" class="form-control"></div></div> 
     ...
     <input type="text" name="p5" placeholder="输入加价价格(元)" value="<?=$row['p_level5']?>"  class="form-control">
      ...
      </div><div class="modal-footer"><button type="button" data-dismiss="modal" onclick="javascript:history.back(-1);" class="an-btn an-btn-danger">返回首页</button>
     
     <input name="提交" type="submit"  class="an-btn an-btn-success" value="修改信息">  </div></div></div></div>
