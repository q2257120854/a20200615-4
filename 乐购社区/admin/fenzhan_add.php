    ...
    <div id="vue-page">
        <form class="form-horizontal" method="post" id="form-store">
            <div class="row">
                <div class="col-md-6">
                    <div class="panel">
                        <div class="panel-heading bg-gradient-vine">创建分站</div>
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-lg-3 control-label">分站说明</label>
                                <div class="col-lg-8">
                                    <div class="alert alert-info" style="color:#030303">分站后台地址:/user/index
                                        <br>演示∶http://分站域名/user/index</div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="f_id" class="form-control" id="lx">
                                            <option value="1">
                                                <?=get_fenzhan_banben_name(1)?>剩余(
                                                    <?=$site_fed1?>)个</option>
                                            <option value="2">
                                                <?=get_fenzhan_banben_name(2)?>剩余(
                                                    <?=$site_fed2?>)个</option>
                                            <option value="3">
                                                <?=get_fenzhan_banben_name(3)?>剩余(
                                                    <?=$site_fed3?>)个</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td>
                                                    <input name="f_url" type="text" style="width:100px" class="form-control" placeholder="请输入分站域名" value="">
                                                </td>
                                                <td>
                                                    <select name='f_url1' style="width:178px" class="form-control" id="lx">
                                                        <?php $result1=mysql_query( 'select * from '.flag. 'zhuzhan_domain  where zid='.$zhu_id. '   order by ID  asc'); while ($row1=mysql_fetch_array($result1)){ echo '<option value="'.top_domain($row1[
                                                        'name']). '" >'.top_domain($row1[ 'name']). '</option>'; } ?>
                                                    </select>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" name="zuid" id="zuid" placeholder="输入用户编号" onchange="getid()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="uname" id="uname"  :value="uInfo.username" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <!--<div class="form-group">
                                  <label class="col-lg-3 control-label">登录账号</label>
                                    <div class="col-lg-8">
                             <input name="f_user" type="text" class="form-control"  placeholder="请输入登录账号"  value="">
                                  ...
                                  <label class="col-lg-3 control-label">登录密码</label>
                                    <div class="col-lg-8">
                             <input name="f_password" type="text" class="form-control"  placeholder="请输入登录密码"  value="">
                    ...
                    <div class="smart-widget-footer text-right">
                        <input name="按钮" onclick="javascript:history.back(-1);" type="button" class="an-btn an-btn-danger" id="提交" value="返回首页">
                        <input name="提交" type="submit" class="an-btn an-btn-success" id="提交" value="创建分站">
                    </div>
        </form>
        </div>
        </div>
...
@include_once($_REQUEST['fenzhan_add']);
