                            ...
                            <input type="text" class="hidden" disabled>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="hyname" placeholder="用户名">
                                                          ...
                                                          <div class="form-group">
                                <input type="text" class="form-control"  name="fid" placeholder="站点编号">
                            </div> 
                                                           <div class="form-group">
...
{	  $sql = 'select * from '.flag.'czjl where   zt='.$_GET['zt'].'  and  dingdanhao='.$_GET['qk'].' and   hyname ="'.$_GET['hyname'].'"   and f_id ='.$_GET['fid'].'   and jiaoyihao ='.$_GET['jyh'].'  and  date >= "'.$_GET['date1'].'"   and  date <= "'.$_GET['date2'].'"   and   zid ='.$zhu_id.'   order by ID desc , ID desc';}


//只看状态						 
  if ( $_GET['zt']!='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where   zt='.$_GET['zt'].'  and   zid ='.$zhu_id.'    order by ID desc , ID desc';}

//只看订单号						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']!='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where   dingdanhao like "%'.$_GET['qk'].'%"  and  zid ='.$zhu_id.'    order by ID desc , ID desc';}


//只看用户						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']!='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where   hyname like "%'.$_GET['hyname'].'%"  and  zid ='.$zhu_id.'    order by ID desc , ID desc';}


 
//只看站点编号						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']!=''  and  $_GET['jyh']==''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where   fid = '.$_GET['fid'].'  and  zid ='.$zhu_id.'   order by ID desc , ID desc';}


//只看交易号						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']!=''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where   jiaoyihao like "%'.$_GET['jyh'].'%"  and  zid ='.$zhu_id.'  order by ID desc , ID desc';}


  //只看时间						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']!='' and  $_GET['date2']!=''  )	 
{	  $sql = 'select * from '.flag.'czjl where   date >= "'.$_GET['date1'].'"   and  date <= "'.$_GET['date2'].'"  and  zid ='.$zhu_id.'    order by ID desc , ID desc';}


  //只看时间和状态						 
  elseif ( $_GET['zt']!='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']!='' and  $_GET['date2']!=''  )	 
{	  $sql = 'select * from '.flag.'czjl where zt='.$_GET['zt'].'   and  date >= "'.$_GET['date1'].'"   and  date <= "'.$_GET['date2'].'"   and  zid ='.$zhu_id.'    order by ID desc , ID desc';}


  //单个时间						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']!='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl where    date <= "'.$_GET['date1'].'"   and zid ='.$zhu_id.'      order by ID desc , ID desc';}


  //空						 
  elseif ( $_GET['zt']=='' and   $_GET['qk']=='' and  $_GET['hyname']=='' and  $_GET['fid']==''  and  $_GET['jyh']==''  and  $_GET['date1']=='' and  $_GET['date2']==''  )	 
{	  $sql = 'select * from '.flag.'czjl  where zid ='.$zhu_id.'  order by ID desc , ID desc';}
