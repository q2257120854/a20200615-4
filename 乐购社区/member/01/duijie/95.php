 <?
    ...
    $data = array('Api_UserName'=>$loginname,'Api_UserMd5Pass'=>md5($loginpassword),'goods_id'=>$s_duijiesid,'goods_type'=>$s_duijiesqlx,'need_num_0'=>$_POST['num'],$duijiekey1=>$_POST[$key1],$duijiekey2=>$_POST[$key2],$duijiekey3=>$_POST[$key3],$duijiekey4=>$_POST[$key4],'pay_type'=>$duijiefs);  //定义参数  
