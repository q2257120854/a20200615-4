...
<div  >
        ...
        <div class="col-lg-4">
            <div class="user-widget user-widget2">
                <div class="user-widget-body bg-success text-center">
            ...
            <div class="modal-content animated flipInX">
                ...
                <form method="post"  name="ktfzForm" >
                    <div class="modal-body" id="orderInfo">
                      ...
                      <div class="list-group-item list-group-item-info"><input type="text" placeholder="输入网站名称"
                                                                                 name="f_name" class="form-control"></div>
                                                                                 
                                                                                      <div class="list-group-item list-group-item-info"><input type="text" placeholder="请输入后台账号"
                                                                                 name="f_user" class="form-control"></div>
                                                                                 
                                                                                 
                                                                                      <div class="list-group-item list-group-item-info"><input type="password" placeholder="请输入后台密码"
                                                                                 name="f_password" class="form-control"></div>
                        <div class="list-group-item list-group-item-info">
                            <div class="input-group">
                                <input name="f_url" type="text" class="form-control"
                                       placeholder="输入域名前缀" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">
