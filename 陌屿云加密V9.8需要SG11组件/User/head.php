      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item"> 
            <a href="money.php">
            <i class="mdi mdi-currency-jpy"></i> 余额充值</a> 
            </li>
            <li class="nav-item"> 
            <a href="log.php">
            <i class="mdi mdi-monitor-multiple"></i> 加密记录</a> 
            </li>
            <?php if($conf["sg11_kg"]==1){?>
            <li class="nav-item"> 
            <a href="SG11.php">
            <i class="mdi mdi-elephant"></i>SG11加密</a> 
            </li>
            <?php }?>
            <li class="nav-item"> 
            <a href="decipher.php">
            <i class="mdi mdi-script"></i> 在线解密</a> 
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-file-outline"></i> 在线加密</a>
              <ul class="nav nav-subnav">
                <li> <a href="vipjm.php">威盾加密</a> </li>
                <li> <a href="phpjm.php">混淆加密</a> </li>
                <li> <a href="enphp.php">EnPHP加密</a> </li>
              </ul>
            </li>
          </ul>
        </nav>
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2019. <a target="_blank" href=""><?php echo $conf["title"] ?></a></p>
        </div>
      </div>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                <span><?php echo $MoYo['user'] ?> <span class="caret"></span></span>
              </a>
