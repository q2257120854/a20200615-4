...
class cls_paipan
{
	...
	function Shen_niangan($ng,$gz)
	{
		...
		2=>array("文昌贵人","甲乙:巳午","丙戊:申","丁己:酉","庚:亥","辛:子","壬:寅","癸:卯"),
		3=>array("国印贵人","甲:戌","乙:亥","丙:丑","丁:寅","戊:丑","己:寅","庚:辰","辛:巳","壬:未","癸:申"),
	...
	{
		$arr=array(
		0=>array("天德贵人","寅:丁","卯:申","辰:壬","巳:辛","午:亥","未:甲","申:癸","酉:寅","戌:丙","亥:乙","子:己","丑:庚"),
		1=>array("月德贵人","寅午戌:丙","申子辰:壬","亥卯未:甲","巳酉丑:庚"),
		2=>array("天医","寅:丑","卯:寅","辰:卯","巳:辰","午:巳","未:午","申:未","酉:申","戌:酉","亥:戌","子:亥","丑:子"));
		$shens="";
		for($i=0;$i<=2;$i++)
		{
			for($j=1;$j<=count($arr[$i])-1;$j++)
	...
	function Shen_rigan($rg,$gz)
	{
		...
		4=>array("禄神","甲:寅","乙:卯","丙戊:巳","丁己:午","庚:申","辛:酉","壬:亥","癸:子"),
		5=>array("羊刃","甲:卯","乙:寅","丙戊:午","丁己:巳","庚:酉","辛:申","壬:子","癸:亥"),
		6=>array("国印贵人","甲:戌","乙:亥","丙:丑","丁:寅","戊:丑","己:寅","庚:辰","辛:巳","壬:未","癸:申"),
		7=>array("学堂","甲:己亥","乙:壬午","丙:丙寅","丁:丁酉","戊:戊寅","己:己酉","庚:辛巳","辛:甲子","壬:甲申","癸:乙卯"),
		8=>array("词馆","甲:庚寅","乙:辛卯","丙:乙巳","丁:戊午","戊:丁巳","己:庚午","庚:壬申","辛:癸酉","壬:癸亥","癸:壬戌"));
		$shens="";
		$dza=substr($gz,2,2);
		for($i=0;$i<=8;$i++)
		{
