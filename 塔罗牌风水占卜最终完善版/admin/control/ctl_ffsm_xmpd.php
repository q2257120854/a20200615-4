...
class ctl_ffsm_xmpd extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','gua'=>'卦数','title'=>'标题','title_txt'=>'标题含义','guayi'=>'卦含义','lv'=>'什么卦','pd'=>'配对此卦的解释','msg'=>'卦解释','weiji'=>'爱情危机','jianyi'=>'爱情建议'),
            'addTableField'=>array('title','gua','title_txt','guayi','lv','pd','msg','weiji','jianyi'),
			
            'editTableField'=>array('title','gua','title_txt','guayi','lv','pd','msg','weiji','jianyi'),
           
            'listTableField'=>array('title','gua','title_txt','guayi','lv','weiji','jianyi'),
			
            'batchUpdateTableField'=>array('title','gua','title_txt','guayi','lv'),
...
//                SELECT tid,COUNT(*) FROM xingzuo_data WHERE uptime>='2015-09-15 0:00:00' AND uptime<='2015-09-15 23:59:59' GROUP BY tid
        ...
        $size = $config['page_size'] = 18; //每页显示多少
