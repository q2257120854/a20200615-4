...
class ctl_ffsm_zhanxing_shangsheng extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xingzuo'=>'星座','title'=>'简述','content'=>'内容'),
            'addTableField'=>array('title'),

            'editTableField'=>array('title','content'),

            'listTableField'=>array('xingzuo','title'),

            'batchUpdateTableField'=>array('title'),
        ...
        $this->table = 'ffsm_zhanxing_shangsheng';
