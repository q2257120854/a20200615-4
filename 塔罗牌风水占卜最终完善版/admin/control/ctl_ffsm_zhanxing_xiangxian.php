...
class ctl_ffsm_zhanxing_xiangxian extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','num'=>'象限编号','title'=>'描述','content'=>'内容'),
            'addTableField'=>array('num'),

            'editTableField'=>array('title','content'),

            'listTableField'=>array('num','title'),
        ...
        $this->table = 'ffsm_zhanxing_xiangxian';
