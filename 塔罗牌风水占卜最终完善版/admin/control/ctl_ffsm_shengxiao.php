...
class ctl_ffsm_shengxiao extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','sx'=>'生肖','content'=>'内容','m'=>'月份','title'=>'标题'),
            'addTableField'=>array('sx','m','content','title'),
			
            'editTableField'=>array('sx','m','content','title'),
           
            'listTableField'=>array('sx','m','content','title'),
			
            'batchUpdateTableField'=>array('sx','m','content','title'),
