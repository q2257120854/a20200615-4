...
class ctl_ffsm_zhanxing_nengliang extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xx'=>'行星','content'=>'内容'),
            'addTableField'=>array('title'),

            'editTableField'=>array('xx','content'),

            'listTableField'=>array('xx'),
        ...
        $this->table = 'ffsm_zhanxing_nengliang';
