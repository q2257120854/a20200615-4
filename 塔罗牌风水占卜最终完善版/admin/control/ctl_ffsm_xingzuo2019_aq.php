...
class ctl_ffsm_xingzuo2019_aq extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xz'=>'星座','peidui'=>'配对','master'=>'主动权','txt'=>'简述','line'=>'图片地址','jiyu'=>'爱情寄语','taohua'=>'单身桃花运','ganqing'=>'感情运势'),
            'addTableField'=>array('xz'),

            'editTableField'=>array('peidui','master','txt','jiyu','taohua','ganqing'),

            'listTableField'=>array('xz','peidui','master','txt'),
        ...
        $this->table = 'ffsm_xingzuo2019_aq';
