...
class ctl_ffsm_whjk extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'wh'=>array('','notempty','五行必须','all'),
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','wh'=>'五行','jb'=>'易发疾病','zz'=>'易发症状','yd'=>'养生要点','sh'=>'生活起居','ys'=>'饮食调节','bj'=>'保健膳食'),
            'addTableField'=>array('wh','jb','zz','yd','sh','ys','bj'),
			
            'editTableField'=>array('wh','jb','zz','yd','sh','ys','bj'),
           
            'listTableField'=>array('wh','jb'),
			
            'batchUpdateTableField'=>array('wh','jb'),
