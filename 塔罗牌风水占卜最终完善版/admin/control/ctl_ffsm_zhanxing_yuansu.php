...
class ctl_ffsm_zhanxing_yuansu extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','yuansu'=>'元素','content'=>'内容'),
            'addTableField'=>array('yuansu'),

            'editTableField'=>array('yuansu','content'),

            'listTableField'=>array('yuansu'),

            'batchUpdateTableField'=>array('yuansu'),
        ...
        $this->table = 'ffsm_zhanxing_yuansu';
