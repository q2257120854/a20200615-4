...
class ctl_ffsm_xingzuo2019_sy extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xz'=>'星座','guiren'=>'贵人','didian'=>'低谷时期','txt'=>'简述','line'=>'图片地址','zong'=>'总评','work'=>'工作学业','zy'=>'职业学业发展'),
            'addTableField'=>array('xz'),

            'editTableField'=>array('guiren','didian','txt','zong','work','zy'),

            'listTableField'=>array('xz','guiren','didian','txt'),
        ...
        $this->table = 'ffsm_xingzuo2019_sy';
