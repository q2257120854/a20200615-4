...
class ctl_ffsm_xingzuo2019_cy extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xz'=>'星座','gaodian'=>'财富高点','didian'=>'低谷时期','txt'=>'简述','line'=>'图片地址','zong'=>'总评','touzi'=>'投资','zhichu'=>'支出'),
            'addTableField'=>array('xz'),

            'editTableField'=>array('gaodian','didian','txt','zong','touzi','zhichu'),

            'listTableField'=>array('xz','gaodian','didian','txt'),
        ...
        $this->table = 'ffsm_xingzuo2019_cy';
