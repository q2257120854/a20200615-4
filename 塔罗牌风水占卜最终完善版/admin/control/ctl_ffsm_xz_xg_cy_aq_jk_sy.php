...
class ctl_ffsm_xz_xg_cy_aq_jk_sy extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'sx'=>array('','notempty','生肖必须','all'),
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','sx'=>'生肖','yx'=>'生肖优点','qd'=>'生肖缺点','lncy'=>'流年财运','xtcy'=>'先天财运','zhuyi'=>'注意事项','aqfx'=>'爱情分析','th'=>'桃花几多'),
            'addTableField'=>array('sx','yx','qd','lncy','xtcy','zhuyi','aqfx','th'),
			
            'editTableField'=>array('sx','yx','qd','lncy','xtcy','zhuyi','aqfx','th'),
           
            'listTableField'=>array('sx','yx','qd'),
			
            'batchUpdateTableField'=>array('sx','yx','qd'),
        ...
        $this->table = 'ffsm_xz_xg_cy_aq_jk_sy';
