...
class ctl_ffsm_xingzuo2019_base extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','xz'=>'星座','td'=>'特点','sixiang'=>'四象属性','gongwei'=>'掌管宫位','yinyang'=>'阴阳属性','strong'=>'最强特征','shouhu'=>'守护星','jixiang'=>'吉祥物','jinshu'=>'金属','number'=>'幸运数字','yanse'=>'幸运颜色','keyword'=>'性格关键字','xingge'=>'基础性格','youquedian'=>'优点缺点','zhongyao'=>'重要星象'),
            'addTableField'=>array('xz'),

            'editTableField'=>array('td','sixiang','gongwei','yinyang','strong','shouhu','jixiang','jinshu','number','yanse','keyword','xingge','youquedian','zhongyao'),

            'listTableField'=>array('xz','sixiang','gongwei','yinyang','strong'),
            ...
            'xingge'=>array(
                'element'=>array('e_name'=>'textarea','style'=>'width:400px;height:400px;'),
            ),
            'youquedian'=>array(
                'element'=>array('e_name'=>'textarea','style'=>'width:400px;height:400px;'),
            ),
        ...
        $this->table = 'ffsm_xingzuo2019_base';

        //add edit delete batch_update
        $this->_allowAction = array(
            'add'=>array('title'=>'添加','type'=>'dialog','width'=>'700','height'=>'300'),
