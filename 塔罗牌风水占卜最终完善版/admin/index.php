...
$config_access_ctl = cls_access::factory( $config_pool_name, $config_cp_url,$domain );
if($config_access_ctl->fields['uid']){
    $config_access_ctl->keep_user($config_access_ctl->fields['uid']);
}
