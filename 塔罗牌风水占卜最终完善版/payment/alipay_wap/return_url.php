...
if($result) {//验证成功
	...
	$gourl = URL.'?ct=pay&ac=notify&tk='.md5($out_trade_no.'55k').'&'.http_build_query($orders);
	...
	$orders = array('out_trade_no'=>$out_trade_no,'trade_no'=>$trade_no);
	$gourl = URL.'?ct=pay&ac=notify&tk='.md5($out_trade_no).'&'.http_build_query($orders);
