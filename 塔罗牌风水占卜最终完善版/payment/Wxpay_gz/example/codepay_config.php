 ...
 */
$codepay_config['return_url'] = (isHTTPS() ? 'https://' : 'http://').$_SERVER['HTTP_HOST']."/?ac=taluoyunshi&oid=".$_REQUEST["WIDout_trade_no"]; //自动生成跳转地址
...
$codepay_config['notify_url'] = (isHTTPS() ? 'https://' : 'http://').$_SERVER['HTTP_HOST']."/payment/Wxpay_gz/example/notify.php"; //自动生成通知地址 优先级最高不传入则为系统设置里设置
