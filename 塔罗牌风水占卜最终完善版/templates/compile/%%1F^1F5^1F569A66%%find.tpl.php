<?php /* Smarty version 2.6.25, created on 2019-02-28 11:15:33
         compiled from index/bazi/find.tpl */ ?>
﻿<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>八字精批测算结果</title>
...
<link href="/ffsm/statics/ffsm/bazimf/page1.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<section class="page3-bg-1">
  ...
  <div class="material-box">
    ...
    <div class="center clearfix">
      ...
      <span class="value-text"><?php echo $this->_tpl_vars['cookies']['xingming']; ?>
</span></div>
      </div>
        ...
        <div class="infor1 left">
          ...
          <span class="value-text"><?php echo $this->_tpl_vars['cookies']['sex']; ?>
</span></div>
      ...
      <div class="infor-data clearfix">
        ...
        <div class="value-text left">
          <p>新历：<?php echo $this->_tpl_vars['cookies']['nianling']['y']; ?>
年<?php echo $this->_tpl_vars['cookies']['nianling']['m']; ?>
月<?php echo $this->_tpl_vars['cookies']['nianling']['d']; ?>
日 <?php echo $this->_tpl_vars['form']['h']; ?>
时</p>
          <p>旧历：<?php echo $this->_tpl_vars['cookies']['jiuli']['y']; ?>
年<?php echo $this->_tpl_vars['cookies']['jiuli']['m']; ?>
<?php echo $this->_tpl_vars['cookies']['jiuli']['d']; ?>
 <?php echo $this->_tpl_vars['form']['h']; ?>
时</p>
        </div>
      </div>
...
季。</p>
          <p>此八字喜用神「<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['xishen']['xishen']; ?>
」。</p>
          <p>
          </p>
        </div>
  ...
  <div class="content-box page3-content">
    <div class="title clearfix" style="display: flex">
      ...
      <img style="height:27px;margin-top:25px;" src="/ffsm/statics/ffsm/bazimf/images/pic-text4.png" alt=""></div>
...
<?php echo $this->_tpl_vars['cookies']['wh']['7']; ?>
  ...
  <div class="content-box page3-content">
    <div class="title" style="display: flex">
      <span class="icon"></span>
      <img style="height:27px;margin-top:25px;" src="/ffsm/statics/ffsm/bazimf/images/pic-text2.png" alt=""></div>
...
<!--<div style="background-color:#FFFDE5;border:1px solid #E10000;border-radius:8px;color:#000000;font-size:24px;text-align:center;margin:30px 14px;">
  <div style="width:90%;margin:0 auto;">
    <img src="/ffsm/statics/ffsm/bazimf/images/top.png" style="margin:.4rem 0;     height: auto;
    max-width: 100%">
  ...
  <div id="guanzhu" style="width:80%;margin:0 auto;margin-top:40px;display:none;">
    <p>步骤一 : 微信扫码关注</p>
    <p>或长按复制微信号添加 :
      <span style="color:#E10000;">gongzhonghao</span></p>
    <img src="https://www.03ky.com/m/tu/weixin.jpg" style="margin:30px 0;width:60%;">
    <p>步骤二 : 在底栏选择相关功能"
  ...
  <div style="border-radius:8px;color:#000000;font-size:.32rem;text-align:center;margin-top:.32rem;margin-bottom:.32rem;">
    ...
    <section class="sub01" style="margin-top:.26rem;">
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_liunian.png">
        <div>2018运势</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_jingpi.png">
        <div>八字算命</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_caiyun.png">
        <div>一生财运</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_hehun.png">
        <div>八字合婚</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_dayun.png">
        <div>未来十年</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_qiming.png">
        <div>多福起名</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_taohua.png">
        <div>感情运势</div></a>
      <a class="icon_head" href="/">
        <img src="/ffsm/statics/ffsm/bazimf/images/icon_yinyuan.png">
        <div>注定姻缘</div></a>
