<?php /* Smarty version 2.6.25, created on 2019-01-30 23:24:41
         compiled from index/yuncheng/form.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8" />
    ...
    <!--full end-->
    <link rel="shortcut icon" href="/ffsm/statics/cdn.12ystar.com/img/favicon2.ico"/>
    ...
    <link href="/ffsm/statics/cdn.12ystar.com/website/Content/hlybz/css/wap.min.css" rel="stylesheet" type="text/css">
    <link href="/ffsm/statics/cdn.12ystar.com/website/Content/hlybz/css/style.min.css" rel="stylesheet" type="text/css">
    <link href="/ffsm/statics/cdn.12ystar.com/website/Content/hlybz/css/swiper-3.4.2.css" rel="stylesheet" type="text/css">
...
<body>
    <header class="public_header">
        ...
        <h1 class="public_h_con" style="color:#d23037">年度运程详批</h1>
    ...
    <div class="public_banner">
        <img src="/ffsm/statics/img/yunshi_index_banner.png" alt="八字精批" />
        <!--<img src="/ffsm/statics/cdn.12ystar.com/img/index_dashi.png" alt="八字精批" />-->
    </div>
    
    <div style="background-color:#faf1d3">
            ...
            <div>
                <style>
                    .top_notice {
                        ...
                        .top_notice strong {
                            ...
                            .top_notice strong::after {
                                content: '';
                                background-image: url(data:image/png;base64,);
                                position: absolute;
                                width: 30px;
                                height: 30px;
                                left: 0;
                ...
                <div class="top_notice">
                        <strong class="">专业正版，谨防假冒！</strong>
                </div>
            </div>

        <img style="width:100%;display:block" src="/ffsm/statics/cdn.12ystar.com/img/index_dashi.png">
    </div>
    
    <form class="J_ajaxForm J_testFixedTop" id="submit1" action="/?ac=yuncheng" name="login" method="post">
        ...
        <input type="hidden" name='cp'  value="<?php echo $this->_tpl_vars['cp']; ?>
">
    ...
    <div class="public_bg_color"><div class="public_border_title"><div class="b_t_up"><span></span></div><div class="b_t_body"><span>测算后您将知道以下信息</span></div><div class="b_t_down"><span></span></div></div><p class="public_bzjp_box"><img src="/ffsm/statics/img/ad_banner.png" alt="测算后您将知道以下信息"></p></div>
    
    
    <!--<div class="public_bg_color"><div class="public_border_title"><div class="b_t_up"><span></span></div><div class="b_t_body"><span>测算内容对您有什么帮助</span></div><div class="b_t_down"><span></span></div></div><p class="public_bzjp_box"><img src="/ffsm/statics/cdn.12ystar.com/img/003.jpg" alt="测算后您将知道以下信息"></p></div>-->
    
    <div class="public_bg_color"><div class="public_border_title"><div class="b_t_up"><span></span></div><div class="b_t_body"><span>测算内容对您有什么帮助</span></div><div class="b_t_down"><span></span></div></div><p class="public_bzjp_box"><img src="/ffsm/statics/img/body-ad.png" alt="测算后您将知道以下信息"></p></div>
...
<script src="/ffsm/statics/suanming.js"></script>
      ...
      <div style="width:100%;position:relative;">
        ...
        <div style="display:flex;line-height:40px">
          ...
          <div style="width:60px;background-color:#bb1b21;border-top-right-radius:4px;border-bottom-right-radius:4px"><button
              ...
              data-clipboard-action="copy"  data-clipboard-target="#tc_box_wei3" id="btn" class="wxCopynum3">复制</button></div>
        </div>
