<?php /* Smarty version 2.6.25, created on 2019-03-02 13:35:02
         compiled from index/xmpd/form.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>姓名配对-姓名合婚-塔罗占卜姓名配对服务</title>
...
<script src="/ffsm/statics/cdn.12ystar.com/website/Content/hlybz/js/layer.js"></script>
</head>
<body>
...
<div class="banner_top">
	<img src="/ffsm/statics/ffsm/xmpeidui/2/images/banner.jpg" alt="">
</div>
<div class="banner_form">
	<img src="/ffsm/statics/ffsm/xmpeidui/2/images/banner_2.jpg" alt="">
	<div class="bf_form J_testFixedShow" id="formTab">
		<form class="J_ajaxForm" action="/?ac=xmpd" method="post" name="login" id="submit1">
			...
			<div class="bf_input_down">
				...
				<!--<a href="javascript:;" class="J_ajax_submit_btn">开始配对</a>-->
				<div>
					已有<b>1594691</b>人测算
				</div>
			</div>
...
<div class="test_know">
	<h4 class="tk_tip">测算后您将获得</h4>
	<dl>
		<dt class="tk_tit"><span>你俩的姓名姻缘五格</span></dt>
		<dd class="tk_con">测算结果根据五格剖象法及《易经》典籍中的“象”“数”理论，分析男女双方姓名数理配置。</dd>
	</dl>
	<dl>
...
<div class="feedback">
	...
	<div class="feedback_box" id="con2_qhd_3">
		<ul class="feedback_content">
			...
			<p>
				最近有好几个男生对我示好，个人觉得自己条件也算还过得去，就是不明白他们到底是不是真的对我有意思，所以测算了一下彼此的名字，现在我大概知道自己该怎么做了o(^▽^)o。
			</p>
			</li>
			<li>
			<div class="tit">
			...
			<p>
				和对象处了7年了，她一直都不着急结婚，相反双方父母都挺着急的，通过测算才知道我们适合晚婚，我这才放下心来。
			</p>
			</li>
			<li>
			<div class="tit">
			...
			<p>
				也许是一种心理暗示吧，暗恋很久的人了，可是我一直没有勇气是表白，也许是从来没有觉得自己喜欢的东西可是请争取吧，很感谢测算后给我的建议，我现在决定去争取自己的幸福。
			</p>
			</li>
			<li>
			<div class="tit">
			...
			<p>
				通过这次测算，我更加的确定我们俩是天赐良缘，我真的好幸福，我觉得我要对亲爱的好一点。
			</p>
			</li>
			<li>
			<div class="tit">
			...
			<p>
				喜欢她很久了，可是她有男朋友，我也只能在背后祝福她。没想到她上周突然分手了，我来老师这里测算了一次，发现这正是我和她发展感情的契机，我一定要抓住这次机会的。
			</p>
			</li>
			<li>
			<div class="tit">
			...
			<p>
				临近毕业，和男朋友在未来选择上有诸多分歧，加上课业压力大，最近经常吵架。听朋友介绍找到了老师，根据老师的测算，知道我们命中会因事业阻碍影响到感情，需要多迁就对方，适当放弃才能长久，最后男朋友为了照顾我也和我选择了同一家公司，终于重归于好
			</p>
			</li>
		</ul>
	</div>
...
$('.J_ajax_submit_btn').click(function(){
		var malexing = document.login.malexing.value;
		if (malexing == "") {
			layer.msg("请输入男主姓")
			document.login.malexing.focus();
			return false;
		}
		
		var malename = document.login.malename.value;
		if (malename == "") {
			layer.msg("请输入男主名")
		...
		var femalexing = document.login.femalexing.value;
		if (femalexing == "") {
			layer.msg("请输入女主姓")
			document.login.femalexing.focus();
			return false;
		}
		
		var femalename = document.login.femalename.value;
		if (femalename == "") {
			layer.msg("请输入女主名")
