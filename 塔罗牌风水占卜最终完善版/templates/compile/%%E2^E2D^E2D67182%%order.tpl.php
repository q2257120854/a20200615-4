<?php /* Smarty version 2.6.25, created on 2019-04-10 18:06:45
         compiled from index/bzjp/order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8" />
    <title><?php echo $this->_tpl_vars['form']['username']; ?>
缘主的紫微精批，免费试听命盘主星解读</title>
...
<div class="wrap" style="background:none">
    ...
    <h3 class="dsPayTitle" style="background-color:#e92c4d">张道鸿大师为您进行一生命格详批</h3>
    <div class="clearfix avBox" style="border-bottom: 0;padding-bottom:0.2rem">
        <div class="avLeft">
            <div class="avBos">
                <div class="imgBox">
                    <img src="/ffsm/statics/cdn.12ystar.com/head.png" alt="">
...
&type=2" style="display:">
        ...
        <div style="background-color: #ffcebd;border-radius: 5px;padding: 10px 10px;margin:5px 20px;">
            ...
            <p style="display: none">张道鸿师已经为您分析出一生恋爱婚姻、事业、财富等命运情况，还有2017~2018年运势分析，让您在新的一年事事顺利，升职加薪！</p>
        </div>
    ...
    <div class="lock_content" id='showme'>
        <dl>
            <dt>命盘解密</dt>
            <dd>
                <div class="a3_bz_intro" style="display: block;text-indent: 0;">旦夕祸福一次掌握，今年内有何重大变故，亲情、爱情、事业、财富等有什么需要特别注意的地方？吉像、凶相、命况几何，均有详细解说。</div>
                <div style="position: relative">

                    <div style="position: relative;width: 100%;top: 0">
                        <p class="bigtip" style="padding-top: 0.5rem">点出你命盘中事业、财富、</p>
                        <p class="bigtip">爱情等方面的能量强弱，</p>
                        <p class="bigtip">扬长避短，把握自己的命运！</p>
        ...
        <dl>
            ...
            <dd>
                ...
                <div style="position: relative">
                    <div style="position: relative;width: 100%;top: 0">
                        <p class="bigtip" style="padding-top: 0.5rem">你一生的财富如何，财富是多是寡？</p>
                        <p class="bigtip">你何时会发财？</p>
                        <p class="bigtip">你做什么行业最赚钱？</p>
                        <p class="bigtip">你的偏财如何？</p>
                        <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                            <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                        </div>
                    </div>
        ...
        <dl>
            ...
            <dd>
                ...
                <div style="position: relative">
                    ...
                    <div style="position: relative;width: 100%;top: 0">
                        <p class="bigtip" style="padding-top: 0.5rem">告诉你一生中可能会有几段感情？</p>
                        <p class="bigtip">会不会离婚？</p>
                        <p class="bigtip">大体结婚时间？</p>
                        <p class="bigtip">总体上婚姻是否过的幸福？</p>
                        <p class="bigtip">另一半是助旺自己还是会拖自己后腿？</p>
                        <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                            <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                        </div>
                    </div>
        ...
        <dl>
            <dt>事业成就</dt>
            <dd>
                <p class="pic" style="padding: 0;text-align: center"><img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/question.png" style="width:3rem" alt=""></p>
                <div>
                    <p class="" style="padding:0  0.3rem">
                        命中你的事业会坎坎坷坷，还是平步直上？
                        困境时，会不会有贵人相助？
                        少年得志还是到老才事业安稳？
                    </p>
        ...
        <dl>
            ...
            <dd>
                ...
                <div>
                    <p class="" style="padding:0  0.3rem">
                        你命中疾病有无？健康如何？会不会多病多疼痛？有没有血光灭身之灾？以及命中注定的寿命有多长，能否善始善终？
                    </p>
                    <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                        <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                    </div>
        ...
        <dl>
            ...
            <dd>
                ...
                <div>
                    <p class="" style="padding:0  0.3rem">
                        你命中一生运势几何？你一生最大的机会在哪？好运何时来临？要知运，必先知命！
                    </p>
                    <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                        <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                    </div>
        ...
        <dl>
            <dt>大师总结分析</dt>
            <dd>
                <p class="pic" style="padding: 0.5rem 0;text-align: center"><img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/dashi_score.png" style="width:5rem" alt=""></p>
                <div>
                    <p class="" style="padding:0  0.3rem">
                        你是会郁郁而终，空忙一生？
                        抑或是事事都顺，家庭和睦，无疾而终？
                        你的命中注定是旺还是衰？在此综合命理纲要，给你一个圆满答案。
                    </p>
                    <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                        <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                    </div>
    ...
    <h3 class="dsPayTitle" style="background-color:#e92c4e;display:none">张道鸿大师为您进行一生命格详批</h3>
      ...
      <div style="width:100%;position:relative;">
            ...
            <tbody>
              <tr>
                <td style="font-size:14px;padding-left:5px">
                  <p>首次关注公众号【<span id="tc_box_wei2" style="color:#F93">六六大顺文化传媒</span>】免单</p>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div style="display:flex;line-height:40px">
          <div style="flex:1;border:1px solid #bb1b21;border-top-left-radius:4px;border-bottom-left-radius:5px;text-align:center">
            <p id="tc_box_wei3" style="color:#bb1b21;text-align:center;padding:0;margin:0;font-size:20px">六六大顺文化传媒</p>
          </div>
        ...
        <div style="text-align:center;margin-top:5px"><img style="width:80%" src="/ffsm/statics/img/666.png"></div>
        <div style="height:15px"></div>
      </div>
    </div>
  </div>
