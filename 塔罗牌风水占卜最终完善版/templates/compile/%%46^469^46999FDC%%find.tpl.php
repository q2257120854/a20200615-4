<?php /* Smarty version 2.6.25, created on 2019-02-20 12:03:12
         compiled from index/hmjx/find.tpl */ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/ffsm/statics/ffsm/hmjx/css/_szjx_zhifu_jieguoye.css">
...
<a href="/?ac=history" class="zm_cs">我的测算</a>
    ...
    <h3 class="order_title">订单号：<span><?php echo $this->_tpl_vars['data']['oid']; ?>
</span></h3>
        ...
        <div class="szjx_result_wrap">
            <div class="szjx_top">
                <ul class="szjx_top_wrap">
                    <li class="szjx_top_r">
                        <p>您的号码</p>
                        <p><?php echo $this->_tpl_vars['data']['data']['word']; ?>
</p>
                    </li>
                                        <li class="szjx_top_r">
                        <p>数字磁场组合</p>
                        <p>(<?php echo $this->_tpl_vars['word_z1']; ?>
)<?php echo $this->_tpl_vars['haomajx']['1']['jx']; ?>
、(<?php echo $this->_tpl_vars['word_z3']; ?>
)<?php echo $this->_tpl_vars['haomajx']['3']['jx']; ?>
</p>
                    </li>
                    <li class="szjx_top_r">
                            <p>(<?php echo $this->_tpl_vars['word_z1']; ?>
)磁场特征</p>
                            <p><?php echo $this->_tpl_vars['haomajx']['1']['content']; ?>
</p>
                        </li><li class="szjx_top_r">
                            <p>(<?php echo $this->_tpl_vars['word_z3']; ?>
)磁场特征</p>
                            <p><?php echo $this->_tpl_vars['haomajx']['3']['content']; ?>
</p>
                        </li>
                </ul>
            </div>
                    ...
                    <ul class="szjx_result_ul">
                        <li class="szjx_li">
                            <div class="ul_li_title">
                                <p>从您号码中的(<?php echo $this->_tpl_vars['word_z1']; ?>
)数字磁场分析您的婚姻：</p>
...
夫妻生活是门学问，需要夫妻双方努力去维系，和谐的夫妻生活关键是知进退，多关心谅解对方，迎合伴侣的感情态度可以有效加强婚姻美满度。婚姻感情需要需要清楚自身的爱情态度，找出自己在感情方面的不足之处，选择真正适合自己的对象，可以查看自身的婚姻感情分析。想要知道伴侣的感情态度就需要结合伴侣的命理信息来分析。</p>
                        ...
                        <li class="szjx_li">
                            <div class="ul_li_title">
                                <p>从您号码中的(<?php echo $this->_tpl_vars['word_z2']; ?>
)数字磁场分析您的财运：</p>
                                <span class="checkPromt">展开</span>
                            </div>
                            <div class="ul_li_content">
...
财富的好坏虽然命中有定数，但缺乏行动努力一切都变得不现实。但命中财运不好怎么办？就需要看流年的运程，运势不好的年份需要走得慢一点，稳中求胜；运势好的年运可以加快步伐，挑战各种机遇。至于无法留下贮蓄怎么办？自己没法留可以交给其它人帮忙保管，像爸妈、婚姻伴侣都可以，又或者把生活必须外的钱在银行设个定期存款，减低流动性。</p>
                        ...
                        <li class="szjx_li">
                            <div class="ul_li_title">
                                <p>从您号码中的(<?php echo $this->_tpl_vars['word_z3']; ?>
)数字磁场分析您的事业：</p>
                                <span class="checkPromt">展开</span>
                            </div>
                            <div class="ul_li_content">
...
事业成就高低和努力是密不可分，但并不意味着您努力了就可以有收获，关键是努力的方向需要正确的。所以您需要选择适合自己的事业和方向发展，这可以令您更容易发挥自身能力，获得成功。</p>
                        ...
                        <li class="szjx_li">
                            <div class="ul_li_title">
                                <p>从您号码中的(<?php echo $this->_tpl_vars['word_z4']; ?>
)数字磁场分析您的健康：</p>
                                <span class="checkPromt">展开</span>
                            </div>
                            <div class="ul_li_content">
...
需要关注自身健康情况，注意保养容易患病的部分，每年的身体检查肯定是必不可少的。预防胜于治疗，注意好自己的作息时间和饮食习惯，有时间再做适量的运动，保持健康其实很容易。</p>
                        ...
                        <li class="szjx_li">
                            ...
                            <div class="ul_li_content">
                                <p><?php echo $this->_tpl_vars['haomajx']['0']['content']; ?>
</p>
                        ...
                        <li class="szjx_li">
                            <div class="ul_li_title">
                                <p>根据您的号码尾数(<?php echo $this->_tpl_vars['word_z6']; ?>
)起卦结果分析：</p>
                                <span class="checkPromt">展开</span>
                            </div>
                            <div class="ul_li_content">
                                    <div class="liuyao_msg">
                                        ...
                                        <div class="liuyao_pan">
                                            ...
                                            <ul class="liuyao_left">
                                                <li>
                                                    <span>白虎</span>
                                                    <span class="liuyao_icon"><img src="/ffsm/statics/ffsm/hmjx/picture/03_1.png" alt=""></span>
                                                    <span>兄弟己巳火</span>
                                                    <span>世</span>
                                                </li>
                                                <li>
                                                    <span>腾蛇</span>
                                                    <span class="liuyao_icon"><img src="/ffsm/statics/ffsm/hmjx/picture/03_2.png" alt=""></span>
                                                    <span>子孙己未土</span>
                                                    <span></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <span>青龙</span>
                                                    <span class="liuyao_icon"><img src="/ffsm/statics/ffsm/hmjx/picture/03_4.png" alt=""></span>
                                                    <span>子孙己丑土</span>
                                                    <span></span>
                                                </li>
                                                <li>
