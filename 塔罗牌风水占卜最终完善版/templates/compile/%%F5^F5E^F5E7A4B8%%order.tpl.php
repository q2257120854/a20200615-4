<?php /* Smarty version 2.6.25, created on 2019-01-30 23:24:54
         compiled from index/yuncheng/order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8" />
...
<div class="wrap" style="background:none">
    ...
    <h3 class="dsPayTitle" style="background-color:#e92c4d">钱韶光大师为您进行一生命格详批</h3>
...
&type=2" style="display:">
    ...
    <div class="lock_content" id='showme'>
        <dl>
            <dt>2019年流年神煞</dt>
            <dd>
                <div class="a3_bz_intro" style="display: block;text-indent: 0;">神煞有吉凶，影响各不同。吉者，曰星曰神；凶者，曰杀曰煞。遇吉则更吉，遇凶则更凶。提前了解神煞对您的生活影响，防范于未然。</div>
        ...
        <dl>
            ...
            <dd>
                ...
                <div style="position: relative">
                    <div style="position: relative;width: 100%;top: 0">
                        <p class="bigtip" style="padding-top: 0.5rem">1、今年的流年运势是吉是凶？</p>
                        <p class="bigtip">2、今年会有哪些机遇？如何抓住机会？</p>
                        <p class="bigtip">3、今年会有哪些灾祸？如何预防避开？</p>
                        <p class="bigtip">4、你的偏财如何？</p>
                        <div style="text-align: center;margin:0.1rem 0 0.3rem 0">
                            <img src="/ffsm/statics/cdn.12ystar.com/img/m/610/img/sm/ziwei/lijijiexiao.png" style="width: 4.5rem" />
                        </div>
                    </div>
