<?php /* Smarty version 2.6.25, created on 2019-02-14 13:50:44
         compiled from admin/fxdl.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'admin/fxdl.index.tpl', 276, false),)), $this); ?>
...
" <?php if($this->_tpl_vars['search'.$this->_tpl_vars['k']]==$this->_tpl_vars['kk'])echo 'selected';?> ><?php echo $this->_tpl_vars['vv']; ?>
            ...
            总金额：<?php echo $this->_tpl_vars['total']; ?>
,
            
            待付金额：<?php echo $this->_tpl_vars['daifu']; ?>
,
            
            已结算金额：<?php echo $this->_tpl_vars['jiesuan']; ?>
