requirejs.config({
	baseUrl: "/ffsm/statics/ffsm/public/js/",
	map: {
		"*": {
			css: "/ffsm/statics/ffsm/public/js/require/css.min.js"
		}
	},
	shim: {},
	paths: {
		"ffsm.layer": "/ffsm/statics/ffsm/public/js/layer/layer",
		"ffsm.datepicker": "/ffsm/statics/ffsm/public/js/chenrf/rui-datepicker.min",
		"ffsm.ajaxForm": "/ffsm/statics/ffsm/public/js/libs/ajaxForm.min",
		"ffsm.zhChinese": "/ffsm/statics/ffsm/public/js/libs/zhChinese.min"
	}
}), define("layer", ["ffsm.layer"], function() {
	layer.config({
		path: "/ffsm/statics/ffsm/public/js/layer/"
	})
}), $(function() {
	...
	}), $(".Js_date").length > 0 && require(["ffsm.datepicker", "css!/ffsm/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
